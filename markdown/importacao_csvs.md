...
![imagem3](..\markdown\assets\importacao_csvs/image3.png)
...
![imagem4](..\markdown\assets\importacao_csvs/image4.png)

Menu:

![imagem5](..\markdown\assets\importacao_csvs/image5.png)

Submenu:

![imagem6](..\markdown\assets\importacao_csvs/image6.png)


No submenu acima referido, é onde o utilizador tem de fazer a importação do ficheiro, pressionando para o efeito o botão![botão_importar](..\markdown\assets\importacao_csvs/botão_importar.png).

Nova tela surge, sendo que o utilizador tem de escolher o caminho para chegar ao ficheiro criado nos passos anteriores.

![imagem7](..\markdown\assets\importacao_csvs/image7.png)
...
![imagem8](..\markdown\assets\importacao_csvs/image8.png)
...
![imagem9](..\markdown\assets\importacao_csvs/image9.png)
...
Se o ficheiro apresentar o aspeto acima demonstrado, quer dizer que não foram detetados problemas entre a estrutura do ficheiro, sendo que nesta etapa o utilizador pode fazer a importação, pressionando para o efeito o botão ![botão_importa_ligação](..\markdown\assets\importacao_csvs/botão_importa_ligação.png).

Uma nova mensagem surge e o ficheiro integrado, dando-se assim como encerrado o carregamento.

![imagem10](..\markdown\assets\importacao_csvs/image10.png)
...
Cabimentos:
![imagem11](..\markdown\assets\importacao_csvs/image11.png)

Compromissos:
![imagem12](..\markdown\assets\importacao_csvs/image12.png)

Menu:
![imagem13](..\markdown\assets\importacao_csvs/image13.png)

Submenu:
![imagem14](..\markdown\assets\importacao_csvs/image14.png)
...
- Erro no ficheiro;
- Ficheiro testado e pronto para importação;
![imagem15](..\markdown\assets\importacao_csvs/image15.png)
...
![imagem16](..\markdown\assets\importacao_csvs/image16.png)

Menu:
![imagem17](..\markdown\assets\importacao_csvs/image17.png)

Submenu:
![imagem18](..\markdown\assets\importacao_csvs/image18.png)

![imagem19](..\markdown\assets\importacao_csvs/image19.png)
...
**P1**
![imagem20](..\markdown\assets\importacao_csvs/image20.png)

**P2**
![imagem21](..\markdown\assets\importacao_csvs/image21.png)

Para integração dos ficheiros criados no passo anterior, deve o utilizador usar o seguinte caminho:

Menu:
![imagem22](..\markdown\assets\importacao_csvs/image22.png)
...
**P1**
![imagem23](..\markdown\assets\importacao_csvs/image23.png)


**P2**
![imagem24](..\markdown\assets\importacao_csvs/image24.png)
...
![imagem25](..\markdown\assets\importacao_csvs/image25.png)
...
![imagem26](..\markdown\assets\importacao_csvs/image26.png)

Os ficheiros de integração são os seguintes:

**AM**

![imagem27](..\markdown\assets\importacao_csvs/image27.png)

**AB**

![imagem28](..\markdown\assets\importacao_csvs/image28.png)

**AL**

![imagem29](..\markdown\assets\importacao_csvs/image29.png)
...
![imagem30](..\markdown\assets\importacao_csvs/image30.png)

Menu:

![imagem31](..\markdown\assets\importacao_csvs/image31.png)

Submenu:

![imagem32](..\markdown\assets\importacao_csvs/image32.png)

Nova tela surge, sendo que o utilizador tem de escolher o caminho para chegar ao ficheiro criado com extensão CSV.

![imagem33](..\markdown\assets\importacao_csvs/image33.png)
...
![imagem34](..\markdown\assets\importacao_csvs/image34.png)
...
![imagem35](..\markdown\assets\importacao_csvs/image35.png)

Se o ficheiro apresentar o aspeto acima demonstrado, quer dizer que não foram detetados problemas entre a estrutura do ficheiro, sendo que nesta etapa o utilizador pode fazer a importação, pressionando para o efeito o botão![botão_importa_ligação](..\markdown\assets\importacao_csvs/botão_importa_ligação.png).

![imagem36](..\markdown\assets\importacao_csvs/image36.png)
...
![imagem37](..\markdown\assets\importacao_csvs/image37.png)
...
![imagem38](..\markdown\assets\importacao_csvs/image38.png)

Menu:

![imagem39](..\markdown\assets\importacao_csvs/image39.png)

Submenu:

![imagem40](..\markdown\assets\importacao_csvs/image40.png)

Procedimento igual aos efetuados anteriormente, em que o utilizador escolhe o ficheiro CSV no diretório de origem.

![imagem41](..\markdown\assets\importacao_csvs/image41.png)
...
**Ficheiro Testado e pronto para importação:**
![imagem42](..\markdown\assets\importacao_csvs/image42.png)


Se o ficheiro apresentar o aspeto acima demonstrado, quer dizer que não foram detetados problemas entre a estrutura do ficheiro, sendo que nesta etapa o utilizador pode fazer a importação, pressionando para o efeito o botão! [botão_importa_ligação](..\markdown\assets\importacao_csvs/botão_importa_ligação.png).

![imagem43](..\markdown\assets\importacao_csvs/image43.png)
...
![imagem44](..\markdown\assets\importacao_csvs/image44.png)

Menu:

![imagem45](..\markdown\assets\importacao_csvs/image45.png)


Submenu:

![imagem46](..\markdown\assets\importacao_csvs/image46.png)
...
![imagem47](..\markdown\assets\importacao_csvs/image47.png)
...
![imagem48](..\markdown\assets\importacao_csvs/image48.png)
...
![imagem49](..\markdown\assets\importacao_csvs/image49.png)
...
![imagem50](..\markdown\assets\importacao_csvs/image50.png)

Menu:

![imagem51](..\markdown\assets\importacao_csvs/image51.png)

Submenu:

![imagem52](..\markdown\assets\importacao_csvs/image52.png)
...
![imagem53](..\markdown\assets\importacao_csvs/image53.png)
...
![imagem54](..\markdown\assets\importacao_csvs/image54.png)
...
![imagem55](..\markdown\assets\importacao_csvs/image55.png)
