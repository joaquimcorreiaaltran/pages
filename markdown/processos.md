...
![img_1.png](..\markdown\assets\processos\img_1.png)
...
![img_2.png](..\markdown\assets\processos\img_2.png)
...
|Orçamento Ordinário|Seleção apenas se for a introdução de um orçamento ordinário ![img_orç_ordinario.png](..\markdown\assets\processos\img_orç_ordinario.png) |Todos|
|Alteração Orçamental|Seleção apenas se for uma alteração orçamental a registar. Ao selecionar, automaticamente aparece o número de lançamento o qual se pretende alterar. ![img_alteracao_orc_num_lancamento.png](..\markdown\assets\processos\img_alteracao_orc_num_lancamento.png) |Todos|
|Atividade/Departamento|Identificação do tipo de Atividade/Departamento. Na seleção do botão de ajuda, o utilizador carregando no círculo ![img_radio_unselected.png](..\markdown\assets\processos\img_radio_unselected.png) pode obter uma listagem de todos os tipos de Atividades/Departamentos.|Todos|
|Data|---?---|Todos|
...
![img_3.png](..\markdown\assets\processos\img_3.png)

Importante referir que o botão ![desdobrar_conta.png](..\markdown\assets\processos\img_desdobrar_conta.png), permite desdobrar os classificadores económicos e permite o registo de diferentes chaves orçamentais.
Ao clicar no ![confirme.png](..\markdown\assets\processos\img_confirme.png), o sistema criará assim de forma automática um novo ecrã, com a criação da PO.
O utilizador tem de proceder à aprovação, através do botão ![aprovar.png](..\markdown\assets\processos\img_aprovar.png). Assim dá indicação ao sistema que os valores anteriormente carregados, fazem parte do orçamento ordinário.

![img_4.png](..\markdown\assets\processos\img_4.png)
...
![img_5.png](..\markdown\assets\processos\img_5.png)
...
![img_6png](..\markdown\assets\processos\img_6.png)
...
![img_7.png](..\markdown\assets\processos\img_7.png)
...
![img_10.png](..\markdown\assets\processos\img_10.png)
...
![img_7a.png](..\markdown\assets\processos\img_7a.png)
...
![img_8a.png](..\markdown\assets\processos\img_8a.png)
...
![img_9a.png](..\markdown\assets\processos\img_9a.png)
...
![img_12.png](..\markdown\assets\processos\img_12.png)

![img_13.png](..\markdown\assets\processos\img_13.png)
...
![img_14.png](..\markdown\assets\processos\img_14.png)

![img_15.png](..\markdown\assets\processos\img_15.png)

![img_16.png](..\markdown\assets\processos\img_16.png)

![img_17.png](..\markdown\assets\processos\img_17.png)

![img_18.png](..\markdown\assets\processos\img_18.png)

![img_19.png](..\markdown\assets\processos\img_19.png)

![img_20.png](..\markdown\assets\processos\img_20.png)

![img_21.png](..\markdown\assets\processos\img_21.png)

![img_22.png](..\markdown\assets\processos\img_22.png)

![img_23.png](..\markdown\assets\processos\img_23.png)

No final de cada mês, o utilizador ao Confirmar, surge no ecrã a indicação de:

![img_24.png](..\markdown\assets\processos\img_24.png)
...
![img_25.png](..\markdown\assets\processos\img_25.png)
...
![img_28.png](..\markdown\assets\processos\img_28.png)

#### Criação com fundos disponíveis

![img_29.png](..\markdown\assets\processos\img_29.png)

#### Geração de movimentos contabilísticos e confirmação

![img_30.png](..\markdown\assets\processos\img_30.png)
...
![img_31.png](..\markdown\assets\processos\img_31.png)
...
|Mapa|Este botão permite ao utilizador consultar diretamente o mapa no ecrã. ![img_32.png](..\markdown\assets\processos\img_32.png)|
|Sair|Este botão permite ao utilizador sair do ecrã corrente.|
...
|:----|:---------|:---------|
|Ano|Exercício a que dizem respeito as informação da instituição.|Todos|
|Mês|Seleção do mês para carregamento dos fundos. ![img_mes_janeiro.png](..\markdown\assets\processos\img_mes_janeiro.png)|Todos|
|Diretório|Este botão permite ao utilizador escolher o diretório de gravação do Excel que irá ser produzido. ![img_33.png](..\markdown\assets\processos\img_33.png)|Todos|
...
![img_34.png](..\markdown\assets\processos\img_34.png)
...
|Extrato|Este botão permite a gravar alterações que no diretório escolhido pelo utilizador.|
|XML|Esta opção permite a produção do mapa em ficheiro com extensão XML.|
|Mapa|Este botão permite ao utilizador consultar diretamente o mapa no ecrã. ![img_35.png](..\markdown\assets\processos\img_35.png)|
|Sair|Este botão permite ao utilizador sair do ecrã corrente.|
...
|Ano|Exercício a que dizem respeito as informação da instituição.|Todos|
|Mês|Seleção do mês para carregamento dos fundos. ![img_mes_janeiro.png](..\markdown\assets\processos\img_mes_janeiro.png)|Todos|
|Diretório|Este botão permite ao utilizador escolher o diretório de gravação do Excel que irá ser produzido. ![img_36.png](..\markdown\assets\processos\img_36.png)|Todos|
...
![img_37.png](..\markdown\assets\processos\img_37.png)
...
![img_38.png](..\markdown\assets\processos\img_38.png)

|Campo|Obrigatoriedade|Descritivo|
|:----|:---------|:---------|
|Exercício|Obrigatório|Exercício a que dizem respeito as informação da instituição.|
|Proposta|Obrigatório|Seleção de um dos campos: ![img_39.png](..\markdown\assets\processos\img_39.png)|
|Orçamento|Obrigatório|Seleção de um dos campos: ![img_40.png](..\markdown\assets\processos\img_40.png) __Ao selecionar a “Alteração Orçamental”, surge automaticamente para preenchimento: ![img_41.png](..\markdown\assets\processos\img_41.png) |
|Financiamento|Obrigatório|Seleção de um dos campos: ![img_42.png](..\markdown\assets\processos\img_42.png)|
|Atividades/Departamento|Obrigatório|Seleção de um dos campos: ![img_43.png](..\markdown\assets\processos\img_43.png)|
|Pri. Data|Obrigatório||
|Últ. Data|Obrigatório||

|Botão|Descritivo|
|:----|:---------|
|Ficheiro|Este botão permite ao utilizador escolher o diretório de gravação do Excel que irá ser produzido. ![img_44.png](..\markdown\assets\processos\img_44.png) ![img_45.png](..\markdown\assets\processos\img_45.png)|
...
![img_46.png](..\markdown\assets\processos\img_46.png)
...
![img_47.png](..\markdown\assets\processos\img_47.png)
...
![img_48.png](..\markdown\assets\processos\img_48.png)
...
![img_49.png](..\markdown\assets\processos\img_49.png)
...
![img_50.png](..\markdown\assets\processos\img_50.png)
...
![img_51.png](..\markdown\assets\processos\img_51.png)
...
![img_52.png](..\markdown\assets\processos\img_52.png)

|Campo|Obrigatoriedade|Descritivo|
|:---|:---|:---|
|Exercício|Obrigatório|Exercício a que dizem respeito as informação da instituição.|
|Proposta|Obrigatório|Seleção de um dos campos: ![img_valores_proposta_orcamental.png](..\markdown\assets\processos\img_valores_proposta_orcamental.png)|
|Orçamento|Obrigatório|Seleção de um dos campos: ![img_alteracao_orcamental.png](..\markdown\assets\processos\img_alteracao_orcamental.png) __Ao selecionar a “Alteração Orçamental”, surge automaticamente para preenchimento: ![img_num_alt_orcamental.png](..\markdown\assets\processos\img_num_alt_orcamental.png)|
|Financiamento|Obrigatório|Seleção de um dos campos: ![img_56.png](..\markdown\assets\processos\img_56.png)|
|Atividades/Departamento|Obrigatório|Seleção de um dos campos: ![img_57.png](..\markdown\assets\processos\img_57.png)|
|Pri. Data|Obrigatório|Definir a data de início da pesquisa.|
|Últ. Data|Obrigatório|Definir a data final da pesquisa.|

|Botão|Descritivo|
|:---|:---|
|Ficheiro|Este botão permite ao utilizador escolher o diretório de gravação do Excel que irá ser produzido.![img_57a.png](..\markdown\assets\processos\img_57a.png) ![img_57b.png](..\markdown\assets\processos\img_57b.png)|
|Imprimir|Este botão permite que o utilizador gere relatório diretamente no ecrã.|
|Sair|Este botão permite que o utilizador saia do ecrã e regresse ao menu inicial.|

O exemplo seguinte, demonstra um relatório de alteração orçamental gerada em passos anteriores, evidenciando os respetivos itens financeiros e respetivos valores.

![img_54.png](..\markdown\assets\processos\img_54.png)
...
![img_55.png](..\markdown\assets\processos\img_55.png)
...
![img_56.png](..\markdown\assets\processos\img_56.png)

Ao selecionar Cabimentos/Compromissos, irá surgir o seguinte ecrã:

![img_57.png](..\markdown\assets\processos\img_57.png)
...
![img_58.png](..\markdown\assets\processos\img_58.png)
...
![img_59.png](..\markdown\assets\processos\img_59.png)

A gravação do CB abre novo ecrã, onde teremos um botão de ajuda no preenchimento dos seguintes campos obrigatórios:

![img_60.png](..\markdown\assets\processos\img_60.png)

|Campo|Obrigatoriedade|Descritivo|
|:----|:--------------|:---------|
|Classificador Económico|Obrigatório|Seleção do classificador económico a associar ao Cabimento. ![img_61.png](..\markdown\assets\processos\img_61.png)|
|Conta|Obrigatório|Seleção da conta ao classificador. ![img_62.png](..\markdown\assets\processos\img_62.png)|
...
![img_63.png](..\markdown\assets\processos\img_63.png)
...
![img_64.png](..\markdown\assets\processos\img_64.png)
...
![img_65.png](..\markdown\assets\processos\img_65.png)
...
![img_66.png](..\markdown\assets\processos\img_66.png)
...
![img_67.png](..\markdown\assets\processos\img_67.png)
...
![img_68.png](..\markdown\assets\processos\img_68.png)
...
![img_importacao_concluida_sucesso.png](..\markdown\assets\processos\img_importacao_concluida_sucesso.png)
...
![img_69.png](..\markdown\assets\processos\img_69.png)

O utilizador ao escolher um dos seguintes botões obtém os ecrãs:

#### Informação de CB

![img_70.png](..\markdown\assets\processos\img_70.png)

O utilizador ao pressionar o botão "Imprimir", gera no ecrã o resultado da criação do CB.

![img_72.png](..\markdown\assets\processos\img_72.png)

#### Listagens de CB

![img_74.png](..\markdown\assets\processos\img_74.png)

Nos ecrãs atrás referidos, o procedimento é similar:

|Botão|Descritivo|
|:---|:---|
|Calcular|Este botão permite o resumo do que foi criado no cabimento. ![img_75.png](..\markdown\assets\processos\img_75.png)|
|Imprimir|Este botão permite que o utilizador gere relatório diretamente no ecrã.|
|Ficheiro|Este botão permite ao utilizador escolher o diretório de gravação do Excel que irá ser produzido. ![img_76.png](..\markdown\assets\processos\img_76.png)|
|Sair|Este botão permite que o utilizador saia do ecrã e regresse ao menu inicial.|

O formato na opção "Imprimir", é o seguinte:

![img_77.png](..\markdown\assets\processos\img_77.png)
...
![img_78.png](..\markdown\assets\processos\img_78.png)
...
![img_79.png](..\markdown\assets\processos\img_79.png)
...
![img_80.png](..\markdown\assets\processos\img_80.png)
...
![img_81.png](..\markdown\assets\processos\img_81.png)

O novo ecrã surge e associada a ela, aparecem os movimentos de lançamento do cabimento. Se os lançamentos estiverem corretos, deve o utilizador confirmar, pressionado o botão de confirmação.

![img_82.png](..\markdown\assets\processos\img_82.png)

A alteração ao Cabimento acaba de ser efetuada, sendo que o sistema gera uma mensagem de confirmação.

![img_83.png](..\markdown\assets\processos\img_83.png)
...
![img_84.png](..\markdown\assets\processos\img_84.png)

Ao pressionar, o utilizador vai deparar-se com o seguinte ecrã, sendo que para carregamento do ficheiro, tem de escolher o Diretório de Origem.

![img_85.png](..\markdown\assets\processos\img_85.png)

O aspeto do ficheiro CSV. é o abaixo demonstrado, sendo que o mesmo deve obedecer ao critério das colunas estipuladas, para efeito de carregamento.

![img_86.png](..\markdown\assets\processos\img_86.png)
...
![img_87.png](..\markdown\assets\processos\img_87.png)
...
![img_88.png](..\markdown\assets\processos\img_88.png)
...
![img_91.png](..\markdown\assets\processos\img_91.png)
...
![img_94.png](..\markdown\assets\processos\img_94.png)

Neste ecrã, surge o resumo da criação efetuada no passo anterior

![img_95.png](..\markdown\assets\processos\img_95.png)
...
![img_95a.png](..\markdown\assets\processos\img_95a.png)

O utilizador ao pressionar o botão "Imprimir", gera no ecrã o resultado da criação do CM.

![img_95b.png](..\markdown\assets\processos\img_95b.png)
...
![img_96.png](..\markdown\assets\processos\img_96.png)

Ao pressionar, o utilizador vai deparar-se com o seguinte ecrã, sendo que para carregamento do ficheiro, tem de escolher o Diretório de Origem.

![img_96a.png](..\markdown\assets\processos\img_96a.png)

O aspeto do ficheiro CSV. é o abaixo demonstrado, sendo que o mesmo deve obedecer ao critério das colunas estipuladas, para efeito de carregamento.

![img_97.png](..\markdown\assets\processos\img_97.png)
...
![img_98.png](..\markdown\assets\processos\img_98.png)

Após validação dos elementos integrados e constatado que os valores estão coerentes com o ficheiro integrado, o utilizador deve assim usar o botão "Importa Ligação". Depois de pressionar e de forma automática, o sistema gera uma mensagem de confirmação, com a indicação abaixo discrita.

![img_98a.png](..\markdown\assets\processos\img_98a.png)
...
![img_99.png](..\markdown\assets\processos\img_99.png)
...
![img_100.png](..\markdown\assets\processos\img_100.png)

Ao pressionar, o utilizador vai deparar-se com o seguinte ecrã, sendo que para carregamento do ficheiro, tem de escolher o Diretório de Origem.

![img_101.png](..\markdown\assets\processos\img_101.png)

O aspeto do ficheiro CSV. é o abaixo demonstrado, sendo que o mesmo deve obedecer ao critério das colunas estipuladas, para efeito de carregamento.

![img_102.png](..\markdown\assets\processos\img_102.png)

Antes da importação,o utilizador, tem de usar o botão "Ver/Testar Ficheiro". Ao pressionar este mesmo botão, o utilizador constata que os elementos do ficheiro CSV estão visíveis e que o ficheiro integrado está testado. Caso ocorram erros, os mesmos produzem um relatório no ecrã, na caixa criada para o efeito, no canto inferior direito do ecrã.

![img_104.png](..\markdown\assets\processos\img_104.png)
...
![img_105.png](..\markdown\assets\processos\img_105.png)
...
![img_106.png](..\markdown\assets\processos\img_106.png)

O utilizador neste ecrã e no primeiro separador, deve indicar o nº do compromisso. De forma automática, o sistema gera a data de criação do documento, a conta financeira associada e o respetivo montante. A fase seguinte é a de definir a entidade. Para o efeito deve pressionar sobre o botão "![img_radio_unselected.png](..\markdown\assets\processos\img_radio_unselected.png)" para chamada de todas as entidades registadas na base de dados.

![img_107.png](..\markdown\assets\processos\img_107.png)
...
![img_111.png](..\markdown\assets\processos\img_111.png)
...
![img_112.png](..\markdown\assets\processos\img_112.png)
...
![img_113.png](..\markdown\assets\processos\img_113.png)

Ao gerar os documentos na contabilidade, não esquecer que na analítica terá de ser atribuído um centro de custo para as contas classe 6. Através do botão "![img_radio_unselected.png](..\markdown\assets\processos\img_radio_unselected.png)", o utilizador tem acesso a todos os centros de custo inseridos em sistema.

![img_114.png](..\markdown\assets\processos\img_114.png)
...
![img_117.png](..\markdown\assets\processos\img_117.png)

Ao pressionar, o utilizador vai deparar-se com o seguinte ecrã, sendo que para carregamento do ficheiro, tem de escolher o Diretório de Origem.

![img_118.png](..\markdown\assets\processos\img_118.png)

O aspeto do ficheiro CSV. é o abaixo demonstrado, sendo que o mesmo deve obedecer ao critério das colunas estipuladas, para efeito de carregamento.

![img_119.png](..\markdown\assets\processos\img_119.png)

Antes da importação,o utilizador, tem de usar o botão "Ver/Testar Ficheiro". Ao pressionar este mesmo botão, o utilizador constata que os elementos do ficheiro CSV estão visíveis e que o ficheiro integrado está testado. Caso ocorram erros, os mesmos produzem um relatório no ecrã, na caixa criada para o efeito, no canto inferior direito do ecrã.

![img_120.png](..\markdown\assets\processos\img_120.png)
...
![img_121.png](..\markdown\assets\processos\img_121.png)
...
![img_122.png](..\markdown\assets\processos\img_122.png)

Ao pressionar, o utilizador vai deparar-se com o seguinte ecrã, sendo que para carregamento do ficheiro, tem de escolher o Diretório de Origem.

![img_123.png](..\markdown\assets\processos\img_123.png)

O aspeto do ficheiro CSV. é o abaixo demonstrado, sendo que o mesmo deve obedecer ao critério das colunas estipuladas, para efeito de carregamento.

![img_124.png](..\markdown\assets\processos\img_124.png)

Antes da importação,o utilizador, tem de usar o botão "Verificar Ficheiro". Ao pressionar este mesmo botão, o utilizador constata que os elementos do ficheiro CSV estão visíveis e que o ficheiro integrado está testado. Caso ocorram erros, os mesmos produzem um relatório no ecrã, na caixa criada para o efeito, no canto inferior direito do ecrã.


![img_125.png](..\markdown\assets\processos\img_125.png)
...
![img_126.png](..\markdown\assets\processos\img_126.png)
...
![img_127.png](..\markdown\assets\processos\img_127.png)
...
![img_128.png](..\markdown\assets\processos\img_128.png)
...
![img_129.png](..\markdown\assets\processos\img_129.png)
...
![img_130.png](..\markdown\assets\processos\img_130.png)
...
![img_131.png](..\markdown\assets\processos\img_131.png)
...
![img_132.png](..\markdown\assets\processos\img_132.png)
...
![img_133.png](..\markdown\assets\processos\img_133.png)

|Campo|Descritivo|
|:---|:---|
|NIB/IBAN|Este campo dá a hipótese do utilizador escolher se é um NIB ou um IBAN, aparecendo as seguintes opções: ![img_nib_credor.png](..\markdown\assets\processos\img_nib_credor.png)|
|Motivo|O motivo deverá igualmente ser escolhido dentro das parametrizações inseridas em sistema: ![img_secu_pag_igcp.png](..\markdown\assets\processos\img_secu_pag_igcp.png)|
...
![img_134.png](..\markdown\assets\processos\img_134.png)
...
![img_135.png](..\markdown\assets\processos\img_135.png)
...
![img_139.png](..\markdown\assets\processos\img_139.png)

**Individual**

Deve o utilizador, escolher a entidade da qual pretende extrair a Autorização de Pagamento.

![img_140.png](..\markdown\assets\processos\img_140.png)

:warning:__O utilizador tem de selecionar sempre os documentos que deseja, sejam para consulta ou impressão através da colocação de ![img_checkbox_checked.png](..\markdown\assets\processos\img_checkbox_checked.png) no ecrã.__
...
![img_141.png](..\markdown\assets\processos\img_141.png)

:warning:__O utilizador tem de selecionar sempre os documentos que deseja, sejam para consulta ou impressão através da colocação de ![img_checkbox_checked.png](..\markdown\assets\processos\img_checkbox_checked.png) no ecrã.__
...
|“Pôr autorizações regularizadas”|Opcional|Permite ao utilizador quando o estiver ativo imprimir guias com histórico e em que já tenha ocorrido o recebimento.![img_checkbox_checked_2.png](..\markdown\assets\processos\img_checkbox_checked_2.png)|
|Autorização de Pagamento / Autorização Global de Pagamento|Obrigatório|O utilizador escolhe: ![img_autorizacao_pagamento.png](..\markdown\assets\processos\img_autorizacao_pagamento.png), sendo que, para mais que um registo existe a possibilidade de "Selecionar Todos" ![img_selecionar_todos.png](..\markdown\assets\processos\img_selecionar_todos.png)|
...
![img_144.png](..\markdown\assets\processos\img_144.png)

De forma **Global**, ao selecionar “imprimir”, o sistema produz a Autorização de Pagamento Coletiva em PDF.

![img_145.png](..\markdown\assets\processos\img_145.png)
...
![img_150.png](..\markdown\assets\processos\img_150.png)

|Botão|Descritivo|
|:---|:---|
|Ficheiro|Este botão permite ao utilizador escolher o diretório de gravação do ficheiroTXT. (IGCP) ou XML. (IGCP – Novo) que será gerado. ![img_151.png](..\markdown\assets\processos\img_151.png) ![img_152.png](..\markdown\assets\processos\img_152.png)|
...
![img_153.png](..\markdown\assets\processos\img_153.png)
...
![img_154.png](..\markdown\assets\processos\img_154.png)
...
![img_157.png](..\markdown\assets\processos\img_157.png) ![img_158.png](..\markdown\assets\processos\img_158.png)||
...
![img_160.png](..\markdown\assets\processos\img_160.png)
...
![img_161.png](..\markdown\assets\processos\img_161.png)
...
![img_162.png](..\markdown\assets\processos\img_162.png)
...
![img_163.png](..\markdown\assets\processos\img_163.png)
...
![img_164.png](..\markdown\assets\processos\img_164.png)
...
![img_165.png](..\markdown\assets\processos\img_165.png)

Neste ecrã, o utilizador tem de preencher com a informação de acordo com as instruções do quadro abaixo:

![img_166.png](..\markdown\assets\processos\img_166.png)

:warning:__O utilizador tem de selecionar **sempre** os documentos que deseja, sejam para consulta ou impressão através da colocação do visto ![img_checkbox_checked.png](..\markdown\assets\processos\img_checkbox_checked.png) no ecrã anterior.__
...
![img_168.png](..\markdown\assets\processos\img_168.png)
...
![img_169.png](..\markdown\assets\processos\img_169.png)
...
![img_170.png](..\markdown\assets\processos\img_170.png)
...
![img_171.png](..\markdown\assets\processos\img_171.png)
...
![img_172.png](..\markdown\assets\processos\img_172.png)
...
![img_173.png](..\markdown\assets\processos\img_173.png)
...
![img_174.png](..\markdown\assets\processos\img_174.png)
...
![img_175.png](..\markdown\assets\processos\img_175.png)
...
![img_176.png](..\markdown\assets\processos\img_176.png)
...
![img_177.png](..\markdown\assets\processos\img_177.png)
...
![img_182.png](..\markdown\assets\processos\img_182.png)
...
![img_183.png](..\markdown\assets\processos\img_183.png)
...
|Primeira data|Obrigatório|Definir intervalo primeira data|
|Última data|Obrigatório|Definir intervalo última data|
|Pôr Guias já regularizadas|Opcional|Permite ao utilizador quando o "![img_checkbox_checked_2.png](..\markdown\assets\processos\img_checkbox_checked_2.png)" estiver ativo imprimir guias com histórico e em que já tenha ocorrido o recebimento.|
...
![img_184.png](..\markdown\assets\processos\img_184.png)
...
![img_185.png](..\markdown\assets\processos\img_185.png)
...
![img_186.png](..\markdown\assets\processos\img_186.png)

Os movimentos contabilísticos surgem de forma automática, pelo que o utilizador tem de validar e confirmar.

![img_187.png](..\markdown\assets\processos\img_187.png)
...
![img_188.png](..\markdown\assets\processos\img_188.png)
...
![img_189.png](..\markdown\assets\processos\img_189.png)
...
![img_190.png](..\markdown\assets\processos\img_190.png)
...
![img_191.png](..\markdown\assets\processos\img_191.png)
...
![img_192.png](..\markdown\assets\processos\img_192.png)
...
![img_193.png](..\markdown\assets\processos\img_193.png)
...
![img_194.png](..\markdown\assets\processos\img_194.png)

<a name="cobrancas_co_2"></a>

### Cobranças (CO)

![img_195.png](..\markdown\assets\processos\img_195.png)
...
![img_196.png](..\markdown\assets\processos\img_196.png)
...
![img_197.png](..\markdown\assets\processos\img_197.png)

Os movimentos contabilísticos surgem de forma automática, pelo que o utilizador tem de validar e confirmar.

![img_198.png](..\markdown\assets\processos\img_198.png)
...
![img_199.png](..\markdown\assets\processos\img_199.png)

:warning:__O utilizador tem de selecionar **sempre** os documentos que deseja, sejam para consulta ou impressão através da colocação de um visto ![img_checkbox_checked.png](..\markdown\assets\processos\img_checkbox_checked.png) no ecrã.__

![img_200.png](..\markdown\assets\processos\img_200.png)
...
|Primeira data|Obrigatório|Definir intervalo primeira data|
|Última data|Obrigatório|Definir intervalo última data|
|Outras receitas regularizadas|Opcional|Permite ao utilizador quando o ![img_checkbox_checked_2.png](..\markdown\assets\processos\img_checkbox_checked_2.png) estiver ativo imprimir guias com histórico e em que já tenha ocorrido o recebimento.|
...
![img_201.png](..\markdown\assets\processos\img_201.png)
...
![img_202.png](..\markdown\assets\processos\img_202.png)

O novo ecrã tem o aspeto abaixo mostrado:

![img_203.png](..\markdown\assets\processos\img_203.png)
...
![img_204.png](..\markdown\assets\processos\img_204.png)
...
![img_205.png](..\markdown\assets\processos\img_205.png)
...
![img_206.png](..\markdown\assets\processos\img_206.png)
