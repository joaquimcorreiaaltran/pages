...
![menus-108c6384.png](menus.assets/menus-108c6384.png)
...
Este menu agrega funcionalidades relacionadas com o registo de informação contabilística inserida manualmente ou através de automatismo (importação de CSV).

<!--### 4.1 Recolhas de Movimentos

#### 4.1.1 Receitas de Fundos Próprios

##### 4.1.1.1 Receitas sem Faturas
...
Composição do ecrã:
![Ecrã: Referências MB](menus.assets/menus-d16fa591.png)

| Campo/Botão | Descrição/Ação |
|:---|:---|
| Entidade | Identificador numérico da entidade a listar, digitável manualmente ou através do botão de suporte, à direita. O campo à direita mostra o nome da entidade automaticamente |
| Referência | Referência exacta a listar. Formato: xxxxxxxxx |
| Data | Data a listar. Formato: 31-12-9999 |
| Valor | Valor a listar. Formato: xx,xxx.xx€ |
| ... | Seleção da localização para a exportação do ficheiro CSV |
| Exportar | Execução da exportação para a localização indicada no campo à esquerda |
| Calcular  | Execução da listagem, de acordo com os campos preenchidos no topo do ecrã |
| Sair | Fechar ecrã |

###### Como gerar uma referência MB?

![Animação: como gerar uma referência MB?](menus.assets/menus-700ae22a.gif)

###### Como listar referências MB geradas?

![Animação: Como listar referências MB geradas?](menus.assets/menus-7dd7d8ed.gif)

###### Como exportar para CSV a listagem de referências MB?

![Como exportar referências MB?](menus.assets/menus-988bf528.gif)

###### Exemplo de exportação

![Animação: Exemplo de exportação](menus.assets/menus-8ffd9631.png)
