...
![img_8](https://spmssicc.github.io/pages/markdown/menus.assets/img_8.png)
...
![img_17](https://spmssicc.github.io/pages/markdown/menus.assets/img_17.png)
...
![img_18](https://spmssicc.github.io/pages/markdown/menus.assets/img_18.png)
...
![img_19](https://spmssicc.github.io/pages/markdown/menus.assets/img_19.png)
...
![img_31](https://spmssicc.github.io/pages/markdown/menus.assets/img_31.png)
...
| Ficheiro | Extrair a informação pretendida para um ficheiro de texto com o formato CSV. |
| Imprimir | Imprimir uma listagem de instituições bancárias com base nos critérios definidos. O resultado final será semelhante ao apresentado: ![img_32](https://spmssicc.github.io/pages/markdown/menus.assets/img_32.png) |
| Sair | Sair do ecrã. |
...
![img_33](https://spmssicc.github.io/pages/markdown/menus.assets/img_33.png)
...
![img_35](https://spmssicc.github.io/pages/markdown/menus.assets/img_35.png)
...
![img_36](https://spmssicc.github.io/pages/markdown/menus.assets/img_36.png)
...
| Critério de filtragem | Critério para filtragem da pesquisa. Permite ao utilizador, mediante os critérios de pesquisa disponíveis, efetuar consultas aos dados(contas). Os critérios disponíveis são os indicados na imagem. ![tipo](https://spmssicc.github.io/pages/markdown/menus.assets/img_tipo.png) |
| Critério de posicionamento |  Critério a escolher para realçar um resultado da pesquisa. O utilizador pode escolher uma conta e após carregar no botão, o registo atual passa a ser aquele que o utilizador identificou. ![posicionar_contas](https://spmssicc.github.io/pages/markdown/menus.assets/img_posicionar_contas.png) |
| Tipo | A informação contida neste campo, indica se a conta selecionada é uma conta do tipo Acumulação ou do tipo Movimento. ![acumulacao](https://spmssicc.github.io/pages/markdown/menus.assets/img_acumulacao_movimento.png) |
...
| Tipo de Orçamento | Nesta área é apresentado qual ou quais os tipos de orçamento a que a conta pertence. Na inserção de uma nova conta, o utilizador deve marcar os registo que interessam. ![tipo_de_orcamento](https://spmssicc.github.io/pages/markdown/menus.assets/img_tipo_de_orcamento.png) |
...
![img_46](https://spmssicc.github.io/pages/markdown/menus.assets/img_46.png)
...
![img_52](https://spmssicc.github.io/pages/markdown/menus.assets/img_52.png)
...
| Ficheiro | Extrair a informação pretendida para um ficheiro de texto com o formato CSV.
| Imprimir | Imprimir uma listagem de tipos de diário com base nos critérios definidos. O resultado final será semelhante ao apresentado:![img_53](https://spmssicc.github.io/pages/markdown/menus.assets/img_53.png) |
| Sair | Sair do ecrã. |
...
![img_54](https://spmssicc.github.io/pages/markdown/menus.assets/img_54.png)
...
| Tipo | Este campo indica o tipo de centro de custo.![acumulacao_movimento](https://spmssicc.github.io/pages/markdown/menus.assets/img_acumulacao_movimento.png) |
...
![img_59](https://spmssicc.github.io/pages/markdown/menus.assets/img_59.png)
...
![img_60](https://spmssicc.github.io/pages/markdown/menus.assets/img_60.png)
...
| Intragrupo | Este campos indica se a entidade é intragrupo ou não. Caso seja, é apresentado um campo com o descritivo do intragrupo.![intragrupo](https://spmssicc.github.io/pages/markdown/menus.assets/img_intragrupo.png) |
| Entidade Parceira | Este campos indica se a entidade é uma entidade parceira ou não. Caso seja, é apresentado um campo com o descritivo da entidade parceira.![entidade_parceira](https://spmssicc.github.io/pages/markdown/menus.assets/img_entidade_parceira.png) |
...
| (Entidade) – Tipo | Tipo de número de conta bancária:  - NIB : Numero de Identificação Bancária;  - IBAN : Número Internacional de Conta Bancária.![tipo_nib](https://spmssicc.github.io/pages/markdown/menus.assets/img_tipo_nib.png) |
...
![img_63](https://spmssicc.github.io/pages/markdown/menus.assets/img_63.png)
...
![img_64](https://spmssicc.github.io/pages/markdown/menus.assets/img_64.png)
...
![img_66](https://spmssicc.github.io/pages/markdown/menus.assets/img_66.png)
...
| Email | Endereço de correio eletrónico da entidade. |
| Nº de Contribuinte | Número de identificação fiscal da entidade. |
| (Entidade *Factoring*) – Tipo | Tipo de número de conta bancária:- NIB : Numero de Identificação Bancária;- IBAN : Número Internacional de Conta Bancária.![tipo_nib](https://spmssicc.github.io/pages/markdown/menus.assets/img_tipo_nib.png) |
...
![img_72](https://spmssicc.github.io/pages/markdown/menus.assets/img_72.png)

| Campo | Descrição |
|:---|:---|
| Tipo | Este campo permite ao utilizador efetuar a pesquisa de entidades, através do código da mesma ou do respectivo número de contribuinte.![posicionar_num_contribuinte](https://spmssicc.github.io/pages/markdown/menus.assets/img_posicionar_num_contribuinte.png) |
...
| Exercício | O utilizador tem de obrigatoriamente escolher para qual o exercício que pretende obter a informação, sendo por defeito escolhido o período corrente.![exercicio_2015](https://spmssicc.github.io/pages/markdown/menus.assets/img_exercicio_2015.png) |
...
| Ficheiro | Extrair a informação pretendida para um ficheiro de texto com o formato CSV.
| Imprimir | Imprimir uma listagem de entidades com base nos critérios definidos. O resultado final do documento será semelhante ao apresentado:![img_73](https://spmssicc.github.io/pages/markdown/menus.assets/img_73.png) |
| Email | Enviar informação acerca das entidades por email. Ao carregar no mesmo é apresentado o seguinte ecrã:![img_74](https://spmssicc.github.io/pages/markdown/menus.assets/img_74.png) Neste ecrã o utilizador deve escolher os critérios de selecção para gerar os dados a enviar por email, nomeadamente: - Exercício; - Data de Referência; - Número da primeira entidade; - Número da última entidade; - Tipo de informação pretendida: Conta Corrente, Notas de Encomenda, Autorizações de pagamento ou Faturas em Conferencia/Recepção. Para calcular a informação a enviar, por email, o utilizador deve carregar no botão Calcular. O resultado dos cálculos aparecerá no ecrã. ![calcular](https://spmssicc.github.io/pages/markdown/menus.assets/img_calcular.png)Antes de proceder ao envio do email, o utilizador deve indicar a pasta onde será gravado temporariamente o ficheiro a enviar em anexo à mensagem. ![img_mail_29092015.csv](https://spmssicc.github.io/pages/markdown/menus.assets/img_mail_29092015.csv.png). Para confirmar o envio do documento, o utilizador deve carregar no botão Ficheiro de Mails. ![ficheiro_de_mails](https://spmssicc.github.io/pages/markdown/menus.assets/img_ficheiro_de_mails.png). Para sair do ecrã o utilizador deve carregar no botão Sair. ![sair](https://spmssicc.github.io/pages/markdown/menus.assets/img_sair.png) |
| Sair | Sair do ecrã. |

##### Tabulação – Conta Corrente

![img_75](https://spmssicc.github.io/pages/markdown/menus.assets/img_75.png)
...
![img_83](https://spmssicc.github.io/pages/markdown/menus.assets/img_83.png)
...
| Botão | Ação |
|:---|:---|
| Calcular | Obter o mapa de gestão com base nos critérios indicados pelo utilizador. ![img_84](https://spmssicc.github.io/pages/markdown/menus.assets/img_84.png) |
| Imprimir | Extrair a informação pretendida para um ficheiro de relatório com o formato PDF.![img_85](https://spmssicc.github.io/pages/markdown/menus.assets/img_85.png) |
...
![img_86](https://spmssicc.github.io/pages/markdown/menus.assets/img_86.png)
...
| Botão | Ação |
|:---|:---|
| Calcular | Obter o mapa de gestão com base nos critérios indicados pelo utilizador.![img_88](https://spmssicc.github.io/pages/markdown/menus.assets/img_88.png) |
| Ficheiro CSV | Extrair a informação pretendida para um ficheiro de texto com o formato CSV. O utilizador deve indicar a localização onde o ficheiro será guardado através do seguinte botão: sendo o ficheiro guardado na localização indicada em: O nome do ficheiro será GTFTDATA. |
| Imprimir | Extrair a informação pretendida para um ficheiro de relatório com o formato PDF.![img_89](https://spmssicc.github.io/pages/markdown/menus.assets/img_89.png) |
| Sair | Sair do ecrã atual e voltar ao menu principal. |
