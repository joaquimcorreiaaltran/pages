...
![img_1.png](assets/processos_snc_ap/img_1.png)
...
![img_2.png](assets/processos_snc_ap/img_2.png)
...
| Orçamento Ordinário | Seleção apenas se for a introdução de um orçamento ordinário ![img_orç_ordinario.png](assets/processos_snc_ap/img_orç_ordinario.png) | Todos |
| Alteração Orçamental | Seleção apenas se for uma alteração orçamental a registar. Ao selecionar, automaticamente aparece o número de lançamento o qual se pretende alterar. ![img_alteracao_orc_num_lancamento.png](assets/processos_snc_ap/img_alteracao_orc_num_lancamento.png) | Todos |
| Atividade/Departamento | Identificação do tipo de Atividade/Departamento. Na seleção do botão de ajuda, o utilizador carregando no círculo ![img_radio_unselected.png](assets/processos_snc_ap/img_radio_unselected.png) pode obter uma listagem de todos os tipos de Atividades/Departamentos. | Todos |
| Data | ---?--- | Todos |
...
![img_3.png](assets/processos_snc_ap/img_3.png)

Importante referir que o botão ![desdobrar_conta.png](assets/processos_snc_ap/img_desdobrar_conta.png), permite desdobrar os classificadores económicos e permite o registo de diferentes chaves orçamentais.
Ao clicar no ![confirme.png](assets/processos_snc_ap/img_confirme.png), o sistema criará assim de forma automática um novo ecrã, com a criação da PO.
O utilizador tem de proceder à aprovação, através do botão ![aprovar.png](assets/processos_snc_ap/img_aprovar.png). Assim dá indicação ao sistema que os valores anteriormente carregados, fazem parte do orçamento ordinário.

![img_4.png](assets/processos_snc_ap/img_4.png)
...
![img_5.png](assets/processos_snc_ap/img_5.png)
...
![img_6png](assets/processos_snc_ap/img_6.png)
...
![img_7.png](assets/processos_snc_ap/img_7.png)
...
![img_10.png](assets/processos_snc_ap/img_10.png)
...
![img_7a.png](assets/processos_snc_ap/img_7a.png)
...
![img_8a.png](assets/processos_snc_ap/img_8a.png)
...
![img_9a.png](assets/processos_snc_ap/img_9a.png)
...
![img_12.png](assets/processos_snc_ap/img_12.png)

![img_13.png](assets/processos_snc_ap/img_13.png)
...
![img_14.png](assets/processos_snc_ap/img_14.png)

![img_15.png](assets/processos_snc_ap/img_15.png)

![img_16.png](assets/processos_snc_ap/img_16.png)

![img_17.png](assets/processos_snc_ap/img_17.png)

![img_18.png](assets/processos_snc_ap/img_18.png)

![img_19.png](assets/processos_snc_ap/img_19.png)

![img_20.png](assets/processos_snc_ap/img_20.png)

![img_21.png](assets/processos_snc_ap/img_21.png)

![img_22.png](assets/processos_snc_ap/img_22.png)

![img_23.png](assets/processos_snc_ap/img_23.png)

No final de cada mês, o utilizador ao Confirmar, surge no ecrã a indicação de:

![img_24.png](assets/processos_snc_ap/img_24.png)
...
![img_25.png](assets/processos_snc_ap/img_25.png)
...
![img_28.png](assets/processos_snc_ap/img_28.png)

##### Criação com fundos disponíveis

![img_29.png](assets/processos_snc_ap/img_29.png)

##### Geração de movimentos contabilísticos e confirmação

![img_30.png](assets/processos_snc_ap/img_30.png)
...
![img_31.png](assets/processos_snc_ap/img_31.png)
...
|Mapa|Este botão permite ao utilizador consultar diretamente o mapa no ecrã. ![img_32.png](assets/processos_snc_ap/img_32.png)|
|Sair|Este botão permite ao utilizador sair do ecrã corrente.|
...
|:----|:---------|:---------|
|Ano|Exercício a que dizem respeito as informação da instituição.|Todos|
|Mês|Seleção do mês para carregamento dos fundos. ![img_mes_janeiro.png](assets/processos_snc_ap/img_mes_janeiro.png)|Todos|
|Diretório|Este botão permite ao utilizador escolher o diretório de gravação do Excel que irá ser produzido. ![img_33.png](assets/processos_snc_ap/img_33.png)|Todos|
...
![img_34.png](assets/processos_snc_ap/img_34.png)
...
|Extrato|Este botão permite a gravar alterações que no diretório escolhido pelo utilizador.|
|XML|Esta opção permite a produção do mapa em ficheiro com extensão XML.|
|Mapa|Este botão permite ao utilizador consultar diretamente o mapa no ecrã. ![img_35.png](assets/processos_snc_ap/img_35.png)|
|Sair|Este botão permite ao utilizador sair do ecrã corrente.|
...
|Ano|Exercício a que dizem respeito as informação da instituição.|Todos|
|Mês|Seleção do mês para carregamento dos fundos. ![img_mes_janeiro.png](assets/processos_snc_ap/img_mes_janeiro.png)|Todos|
|Diretório|Este botão permite ao utilizador escolher o diretório de gravação do Excel que irá ser produzido. ![img_36.png](assets/processos_snc_ap/img_36.png)|Todos|
...
![img_37.png](assets/processos_snc_ap/img_37.png)
...
![img_38.png](assets/processos_snc_ap/img_38.png)

| Campo | Obrigatoriedade | Descritivo |
|:----|:---------|:---------|
| Exercício | Obrigatório | Exercício a que dizem respeito as informação da instituição. |
| Proposta | Obrigatório | Seleção de um dos campos: ![img_39.png](assets/processos_snc_ap/img_39.png) |
| Orçamento | Obrigatório | Seleção de um dos campos: ![img_40.png](assets/processos_snc_ap/img_40.png) __Ao selecionar a “Alteração Orçamental”, surge automaticamente para preenchimento: ![img_41.png](assets/processos_snc_ap/img_41.png) |
| Financiamento | Obrigatório | Seleção de um dos campos: ![img_42.png](assets/processos_snc_ap/img_42.png) |
| Atividades/Departamento | Obrigatório | Seleção de um dos campos: ![img_43.png](assets/processos_snc_ap/img_43.png) |
| Pri. Data | Obrigatório ||
| Últ. Data | Obrigatório ||

|Botão|Descritivo|
|:----|:---------|
|Ficheiro|Este botão permite ao utilizador escolher o diretório de gravação do Excel que irá ser produzido. ![img_44.png](assets/processos_snc_ap/img_44.png) ![img_45.png](assets/processos_snc_ap/img_45.png)|
...
![img_46.png](assets/processos_snc_ap/img_46.png)
...
![img_47.png](assets/processos_snc_ap/img_47.png)
...
![img_48.png](assets/processos_snc_ap/img_48.png)
...
![img_49.png](assets/processos_snc_ap/img_49.png)
...
![img_50.png](assets/processos_snc_ap/img_50.png)
...
![img_51.png](assets/processos_snc_ap/img_51.png)
...
![img_52.png](assets/processos_snc_ap/img_52.png)

|Campo|Obrigatoriedade|Descritivo|
|:---|:---|:---|
|Exercício|Obrigatório|Exercício a que dizem respeito as informação da instituição.|
|Proposta|Obrigatório|Seleção de um dos campos: ![img_valores_proposta_orcamental.png](assets/processos_snc_ap/img_valores_proposta_orcamental.png)|
|Orçamento|Obrigatório|Seleção de um dos campos: ![img_alteracao_orcamental.png](assets/processos_snc_ap/img_alteracao_orcamental.png) __Ao selecionar a “Alteração Orçamental”, surge automaticamente para preenchimento: ![img_num_alt_orcamental.png](assets/processos_snc_ap/img_num_alt_orcamental.png)|
|Financiamento|Obrigatório|Seleção de um dos campos: ![img_56.png](assets/processos_snc_ap/img_56.png)|
|Atividades/Departamento|Obrigatório|Seleção de um dos campos: ![img_57.png](assets/processos_snc_ap/img_57.png)|
|Pri. Data|Obrigatório|Definir a data de início da pesquisa.|
|Últ. Data|Obrigatório|Definir a data final da pesquisa.|

|Botão|Descritivo|
|:---|:---|
|Ficheiro|Este botão permite ao utilizador escolher o diretório de gravação do Excel que irá ser produzido.![img_57a.png](assets/processos_snc_ap/img_57a.png) ![img_57b.png](assets/processos_snc_ap/img_57b.png)|
|Imprimir|Este botão permite que o utilizador gere relatório diretamente no ecrã.|
|Sair|Este botão permite que o utilizador saia do ecrã e regresse ao menu inicial.|

O exemplo seguinte, demonstra um relatório de alteração orçamental gerada em passos anteriores, evidenciando os respetivos itens financeiros e respetivos valores.

![img_54.png](assets/processos_snc_ap/img_54.png)
...
![img_55.png](assets/processos_snc_ap/img_55.png)
...
![img_56.png](assets/processos_snc_ap/img_56.png)
...
![img_57.gif](assets/processos_snc_ap/img_57.gif)
...
![img_58.png](assets/processos_snc_ap/img_58.png)

A gravação do CB abre novo ecrã, onde teremos um botão de ajuda no preenchimento dos seguintes campos obrigatórios:

![img_60.gif](assets/processos_snc_ap/img_60.gif)

|Campo|Obrigatoriedade|Descritivo|
|:----|:--------------|:---------|
|Classificador Económico|Obrigatório| No método de registo de contas patrimoniais, disponível a partir do menu de Parametrização>Instituição>Configuações ![9561c58b](assets/processos_snc_ap-9561c58b.png), o classificador económico é mostrado automaticamente através da conta patrimonial, de acordo com a associação feita no menu do Plano de Contas. ![img_61.png](assets/processos_snc_ap/img_61.png) No método de registo de Classificador económico, é necessáiro registar primeiro o classificador económico e a conta patrimonial é mostrada automaticamente|
|Conta|Obrigatório|Seleção da conta ao classificador. ![img_62.png](assets/processos_snc_ap/img_62.png)|
|Valor|Obrigatório|Montante do cabimento: ![img_62a.png](assets/processos_snc_ap/img_62a.png)|
...
![img_63.gif](assets/processos_snc_ap/img_63.gif)
...
![img_64.png](assets/processos_snc_ap/img_64.png)
...
![img_65.png](assets/processos_snc_ap/img_65.png)
...
![img_66.png](assets/processos_snc_ap/img_66.png)
...
![img_67.png](assets/processos_snc_ap/img_67.png)
...
![img_68.png](assets/processos_snc_ap/img_68.png)
...
![img_importacao_concluida_sucesso.png](assets/processos_snc_ap/img_importacao_concluida_sucesso.png)
...
![img_69.png](assets/processos_snc_ap/img_69.png)

O utilizador ao escolher um dos seguintes botões obtém os ecrãs:

##### Informação de CB

![img_70.png](assets/processos_snc_ap/img_70.png)

O utilizador ao pressionar o botão "Imprimir", gera no ecrã o resultado da criação do CB.

![img_72.png](assets/processos_snc_ap/img_72.png)

##### Listagens de CB

![img_74.png](assets/processos_snc_ap/img_74.png)

Nos ecrãs atrás referidos, o procedimento é similar:

|Botão|Descritivo|
|:---|:---|
|Calcular|Este botão permite o resumo do que foi criado no cabimento. ![img_75.png](assets/processos_snc_ap/img_75.png)|
|Imprimir|Este botão permite que o utilizador gere relatório diretamente no ecrã.|
|Ficheiro|Este botão permite ao utilizador escolher o diretório de gravação do Excel que irá ser produzido. ![img_76.png](assets/processos_snc_ap/img_76.png)|
|Sair|Este botão permite que o utilizador saia do ecrã e regresse ao menu inicial.|

O formato na opção "Imprimir", é o seguinte:

![img_77.png](assets/processos_snc_ap/img_77.png)
...
![img_78.png](assets/processos_snc_ap/img_78.png)
...
![img_79.png](assets/processos_snc_ap/img_79.png)
...
![img_80.png](assets/processos_snc_ap/img_80.png)
...
![img_81.png](assets/processos_snc_ap/img_81.png)
...
![img_84.png](assets/processos_snc_ap/img_84.png)

Ao pressionar, o utilizador vai deparar-se com o seguinte ecrã, sendo que para carregamento do ficheiro, tem de escolher o Diretório de Origem.

![img_85.png](assets/processos_snc_ap/img_85.png)

O aspeto do ficheiro CSV. é o abaixo demonstrado, sendo que o mesmo deve obedecer ao critério das colunas estipuladas, para efeito de carregamento.

![img_86.png](assets/processos_snc_ap/img_86.png)
...
![img_87.png](assets/processos_snc_ap/img_87.png)
...
![img_88.png](assets/processos_snc_ap/img_88.png)
...
![img_91.png](assets/processos_snc_ap/img_91.png)
...
![img_94.png](assets/processos_snc_ap/img_94.png)

Neste ecrã, surge o resumo da criação efetuada no passo anterior

![img_95.png](assets/processos_snc_ap/img_95.png)
...
![img_95a.png](assets/processos_snc_ap/img_95a.png)

O utilizador ao pressionar o botão "Imprimir", gera no ecrã o resultado da criação do CM.

![img_95b.png](assets/processos_snc_ap/img_95b.png)

__A novidade no novo sistema SICC é o aparecimento do botão , que permite aos utilizadores carregarem a partir de um documento de Excel vários compromissos de forma muito mais rápida e viável.__
...
![img_96.png](assets/processos_snc_ap/img_96.png)

Ao pressionar, o utilizador vai deparar-se com o seguinte ecrã, sendo que para carregamento do ficheiro, tem de escolher o Diretório de Origem.

![img_96a.png](assets/processos_snc_ap/img_96a.png)

O aspeto do ficheiro CSV. é o abaixo demonstrado, sendo que o mesmo deve obedecer ao critério das colunas estipuladas, para efeito de carregamento.

![img_97.png](assets/processos_snc_ap/img_97.png)

Antes da importação,o utilizador, tem de usar o botão "Ver/Testar Ficheiro". Ao pressionar este mesmo botão, o utilizador constata que os elementos do ficheiro CSV estão visíveis e que o ficheiro integrado está testado. Caso ocorram erros, os mesmos produzem um relatório no ecrã, na caixa criada para o efeito, no canto inferior direito do ecrã.

![img_98.png](assets/processos_snc_ap/img_98.png)

Após validação dos elementos integrados e constatado que os valores estão coerentes com o ficheiro integrado, o utilizador deve assim usar o botão "Importa Ligação". Depois de pressionar e de forma automática, o sistema gera uma mensagem de confirmação, com a indicação abaixo discrita.

![img_98a.png](assets/processos_snc_ap/img_98a.png)
...
![img_99.png](assets/processos_snc_ap/img_99.png)
...
![img_100.png](assets/processos_snc_ap/img_100.png)

Ao pressionar, o utilizador vai deparar-se com o seguinte ecrã, sendo que para carregamento do ficheiro, tem de escolher o Diretório de Origem.

![img_101.png](assets/processos_snc_ap/img_101.png)

O aspeto do ficheiro CSV. é o abaixo demonstrado, sendo que o mesmo deve obedecer ao critério das colunas estipuladas, para efeito de carregamento.

![img_102.png](assets/processos_snc_ap/img_102.png)

Antes da importação,o utilizador, tem de usar o botão "Ver/Testar Ficheiro". Ao pressionar este mesmo botão, o utilizador constata que os elementos do ficheiro CSV estão visíveis e que o ficheiro integrado está testado. Caso ocorram erros, os mesmos produzem um relatório no ecrã, na caixa criada para o efeito, no canto inferior direito do ecrã.

![img_104.png](assets/processos_snc_ap/img_104.png)
...
![img_105.png](assets/processos_snc_ap/img_105.png)
...
![img_111.png](assets/processos_snc_ap/img_111.png)
...
![img_112.png](assets/processos_snc_ap/img_112.png)
...
![img_113.png](assets/processos_snc_ap/img_113.png)

Ao gerar os documentos na contabilidade, não esquecer que na analítica terá de ser atribuído um centro de custo para as contas classe 6. Através do botão "![img_radio_unselected.png](assets/processos_snc_ap/img_radio_unselected.png)", o utilizador tem acesso a todos os centros de custo inseridos em sistema.

![img_114.png](assets/processos_snc_ap/img_114.png)
...
![img_117.png](assets/processos_snc_ap/img_117.png)

Ao pressionar, o utilizador vai deparar-se com o seguinte ecrã, sendo que para carregamento do ficheiro, tem de escolher o Diretório de Origem.

![img_118.png](assets/processos_snc_ap/img_118.png)

O aspeto do ficheiro CSV. é o abaixo demonstrado, sendo que o mesmo deve obedecer ao critério das colunas estipuladas, para efeito de carregamento.

![img_119.png](assets/processos_snc_ap/img_119.png)

Antes da importação,o utilizador, tem de usar o botão "Ver/Testar Ficheiro". Ao pressionar este mesmo botão, o utilizador constata que os elementos do ficheiro CSV estão visíveis e que o ficheiro integrado está testado. Caso ocorram erros, os mesmos produzem um relatório no ecrã, na caixa criada para o efeito, no canto inferior direito do ecrã.

![img_120.png](assets/processos_snc_ap/img_120.png)
...
![img_121.png](assets/processos_snc_ap/img_121.png)
...
![img_122.png](assets/processos_snc_ap/img_122.png)

Ao pressionar, o utilizador vai deparar-se com o seguinte ecrã, sendo que para carregamento do ficheiro, tem de escolher o Diretório de Origem.

![img_123.png](assets/processos_snc_ap/img_123.png)

O aspeto do ficheiro CSV. é o abaixo demonstrado, sendo que o mesmo deve obedecer ao critério das colunas estipuladas, para efeito de carregamento.

![img_124.png](assets/processos_snc_ap/img_124.png)

Antes da importação,o utilizador, tem de usar o botão "Verificar Ficheiro". Ao pressionar este mesmo botão, o utilizador constata que os elementos do ficheiro CSV estão visíveis e que o ficheiro integrado está testado. Caso ocorram erros, os mesmos produzem um relatório no ecrã, na caixa criada para o efeito, no canto inferior direito do ecrã.


![img_125.png](assets/processos_snc_ap/img_125.png)
...
![img_126.png](assets/processos_snc_ap/img_126.png)

__Existe a possibilidade de quando se cria os CE, os mesmos poderem ser: individuais, por entidade ou todos. Permite assim que para vários registos haja a possibilidade de os gerar em massa para a Autorização de Pagamento.__
...
![img_127.png](assets/processos_snc_ap/img_127.png)
...
![img_128.png](assets/processos_snc_ap/img_128.png)
...
![img_129.png](assets/processos_snc_ap/img_129.png)
...
![img_130.png](assets/processos_snc_ap/img_130.png)
...
![img_131.png](assets/processos_snc_ap/img_131.png)
...
![img_132.png](assets/processos_snc_ap/img_132.png)
...
![img_133.png](assets/processos_snc_ap/img_133.png)

|Campo|Descritivo|
|:---|:---|
|NIB/IBAN|Este campo dá a hipótese do utilizador escolher se é um NIB ou um IBAN, aparecendo as seguintes opções: ![img_nib_credor.png](assets/processos_snc_ap/img_nib_credor.png)|
|Motivo|O motivo deverá igualmente ser escolhido dentro das parametrizações inseridas em sistema: ![img_secu_pag_igcp.png](assets/processos_snc_ap/img_secu_pag_igcp.png)|
...
![img_134.png](assets/processos_snc_ap/img_134.png)
...
![img_135.png](assets/processos_snc_ap/img_135.png)
...
![img_139.png](assets/processos_snc_ap/img_139.png)

_Individual_

Deve o utilizador, escolher a entidade da qual pretende extrair a Autorização de Pagamento.

![img_140.png](assets/processos_snc_ap/img_140.png)

__O utilizador tem de selecionar sempre os documentos que deseja, sejam para consulta ou impressão através da colocação de ![img_checkbox_checked.png](assets/processos_snc_ap/img_checkbox_checked.png) no ecrã.__
...
![img_141.png](assets/processos_snc_ap/img_141.png)

__O utilizador tem de selecionar sempre os documentos que deseja, sejam para consulta ou impressão através da colocação de ![img_checkbox_checked.png](assets/processos_snc_ap/img_checkbox_checked.png) no ecrã.__
...
|“Pôr autorizações regularizadas”|Opcional|Permite ao utilizador quando o estiver ativo imprimir guias com histórico e em que já tenha ocorrido o recebimento.![img_checkbox_checked_2.png](assets/processos_snc_ap/img_checkbox_checked_2.png)|
|Autorização de Pagamento / Autorização Global de Pagamento|Obrigatório|O utilizador escolhe: ![img_autorizacao_pagamento.png](assets/processos_snc_ap/img_autorizacao_pagamento.png), sendo que, para mais que um registo existe a possibilidade de "Selecionar Todos" ![img_selecionar_todos.png](assets/processos_snc_ap/img_selecionar_todos.png)|
...
![img_150.png](assets/processos_snc_ap/img_150.png)

|Botão|Descritivo|
|:---|:---|
|Ficheiro|Este botão permite ao utilizador escolher o diretório de gravação do ficheiroTXT. (IGCP) ou XML. (IGCP – Novo) que será gerado. ![img_151.png](assets/processos_snc_ap/img_151.png) ![img_152.png](assets/processos_snc_ap/img_152.png)|
...
![img_153.png](assets/processos_snc_ap/img_153.png)
...
![img_154.png](assets/processos_snc_ap/img_154.png)
...
![img_157.png](assets/processos_snc_ap/img_157.png) ![img_158.png](assets/processos_snc_ap/img_158.png)||
...
![img_160.png](assets/processos_snc_ap/img_160.png)
...
![img_161.png](assets/processos_snc_ap/img_161.png)
...
![img_162.png](assets/processos_snc_ap/img_162.png)
...
![img_163.png](assets/processos_snc_ap/img_163.png)
...
![img_164.png](assets/processos_snc_ap/img_164.png)
...
![img_165.png](assets/processos_snc_ap/img_165.png)

Neste ecrã, o utilizador tem de preencher com a informação de acordo com as instruções do quadro abaixo:

![img_166.png](assets/processos_snc_ap/img_166.png)

__O utilizador tem de selecionar _sempre_ os documentos que deseja, sejam para consulta ou impressão através da colocação do visto ![img_checkbox_checked.png](assets/processos_snc_ap/img_checkbox_checked.png) no ecrã anterior.__
...
![img_168.png](assets/processos_snc_ap/img_168.png)
...
![img_169.png](assets/processos_snc_ap/img_169.png)
...
![img_170.png](assets/processos_snc_ap/img_170.png)
...
![img_171.png](assets/processos_snc_ap/img_171.png)
...
![img_172.png](assets/processos_snc_ap/img_172.png)
...
__Encontrando-se as subcontas 25, em regra, saldadas, a leitura da receita cobrada e da despesa paga tem que ser suportada pelos movimentos acumulados a débito ou a crédito.__

![img_173.png](assets/processos_snc_ap/img_173.png)
...
![img_174.png](assets/processos_snc_ap/img_174.png)
...
![img_175.png](assets/processos_snc_ap/img_175.png)
...
![img_176.png](assets/processos_snc_ap/img_176.png)
...
![img_177.png](assets/processos_snc_ap/img_177.png)
...
![img_182.png](assets/processos_snc_ap/img_182.png)
...
![img_183.png](assets/processos_snc_ap/img_183.png)
...
|Primeira data|Obrigatório|Definir intervalo primeira data|
|Última data|Obrigatório|Definir intervalo última data|
|Pôr Guias já regularizadas|Opcional|Permite ao utilizador quando o "![img_checkbox_checked_2.png](assets/processos_snc_ap/img_checkbox_checked_2.png)" estiver ativo imprimir guias com histórico e em que já tenha ocorrido o recebimento.|
...
![img_184.png](assets/processos_snc_ap/img_184.png)
...
![img_185.png](assets/processos_snc_ap/img_185.png)
...
![img_186.png](assets/processos_snc_ap/img_186.png)

Os movimentos contabilísticos surgem de forma automática, pelo que o utilizador tem de validar e confirmar.

![img_187.png](assets/processos_snc_ap/img_187.png)
...
![img_188.png](assets/processos_snc_ap/img_188.png)
...
![img_189.png](assets/processos_snc_ap/img_189.png)
...
![img_190.png](assets/processos_snc_ap/img_190.png)
...
![img_191.png](assets/processos_snc_ap/img_191.png)

__Realça-se especificamente no caso da recolha de produtos, todos os documentos gerados, devem passar pela faturação.__
...
![img_192.png](assets/processos_snc_ap/img_192.png)
...
__De realçar que foi criado um campo de observações que permite ao utilizador tomar notas necessárias. Pode o utilizador verificar a mesma informação no ponto 3.2.9 deste manual.__

![img_193.png](assets/processos_snc_ap/img_193.png)
...
![img_194.png](assets/processos_snc_ap/img_194.png)

#### 3.2.5. Cobranças (CO)

![img_195.png](assets/processos_snc_ap/img_195.png)
...
![img_196.png](assets/processos_snc_ap/img_196.png)
...
![img_197.png](assets/processos_snc_ap/img_197.png)

Os movimentos contabilísticos surgem de forma automática, pelo que o utilizador tem de validar e confirmar.

![img_198.png](assets/processos_snc_ap/img_198.png)

##### Impressão Documentos OR

Neste passo, é demonstrado o procedimento para fazer as impressões das GR geradas no passo anterior. Para isso, deve o utilizador seguir o seguinte caminho no sistema:

![img_199.png](assets/processos_snc_ap/img_199.png)

__O utilizador tem de selecionar _sempre_ os documentos que deseja, sejam para consulta ou impressão através da colocação de um visto ![img_checkbox_checked.png](assets/processos_snc_ap/img_checkbox_checked.png) no ecrã.__

![img_200.png](assets/processos_snc_ap/img_200.png)
...
|Primeira data|Obrigatório|Definir intervalo primeira data|
|Última data|Obrigatório|Definir intervalo última data|
|Outras receitas regularizadas|Opcional|Permite ao utilizador quando o ![img_checkbox_checked_2.png](assets/processos_snc_ap/img_checkbox_checked_2.png) estiver ativo imprimir guias com histórico e em que já tenha ocorrido o recebimento.|
...
![img_201.png](assets/processos_snc_ap/img_201.png)

__O utilizador pode verificar na impressão o novo campo de “Observações” criado no ponto 3.2.7. .__

## 4. Menu Parametrização

### 4.1. Plano Multidimensional

Neste menu estão contempladas as funcionalidades necessárias para parametrização do Plano Multidimensional.

#### 4.1.1. Plano de Contas - SNC-AP - Recolha

Menu de acesso:

![](assets/processos_snc_ap-18400d08.png)

Formulário de parametrização:

![](assets/processos_snc_ap-0c719d37.png)

#### 4.1.2. Plano de Contas - SNC-AP - Listagens

Menu de acesso:

![](assets/processos_snc_ap-194462ef.png)

Formulário de parametrização:

![](assets/processos_snc_ap-0eab8be0.png)

![](assets/processos_snc_ap-82e39c0d.png)

![](assets/processos_snc_ap-9858d2cb.png)

#### 4.1.3. Classificadores económicos - Recolha

Menu de acesso:

![](assets/processos_snc_ap-b36d31eb.png)

Formulário de parametrização:

![](assets/processos_snc_ap-687d0684.png)

#### 4.1.4. Classificadores económicos - Listagens

![](assets/processos_snc_ap-b2ca1649.png)

![](assets/processos_snc_ap-8a5edfa7.png)

![](assets/processos_snc_ap-64b730c9.png)


#### 4.1.5 Chave Orçamental

Menu de acesso:

![](assets/processos_snc_ap-03e850e8.png)

- Gestão Fonte Financiamento

![](assets/processos_snc_ap-12d9cafa.png)

#### 4.1.4 Chave Orçamental - Gestão Grupos de Fonte Financiamentos

![](assets/processos_snc_ap-2ecd9080.png)

#### 4.1.4 Chave Orçamental - Gestão Programa

![](assets/processos_snc_ap-1121bef0.png)

#### 4.1.4 Chave Orçamental - Gestão Medida

![](assets/processos_snc_ap-2e0aaf99.png)

#### 4.1.4 Chave Orçamental - Gestão Projeto

![](assets/processos_snc_ap-3476fa35.png)

#### 4.1.4 Chave Orçamental - Gestão Regionalização

![](assets/processos_snc_ap-07dbf299.png)

#### 4.1.4 Chave Orçamental - Gestão Atividade

![](assets/processos_snc_ap-847f0c91.png)

#### 4.1.4 Chave Orçamental - Gestão Natureza

![](assets/processos_snc_ap-087fc5a9.png)

#### 4.1.4 Chave Orçamental - Gestão Class. Orgânica

![](assets/processos_snc_ap-604fb2ae.png)





### 4.2. Gestão de Tabelas

#### 4.2.1. Instituições bancárias - Recolha

Neste menu, o utilizador pode fazer as configurações referente às instituições bancárias através da seguinte ecrã.

![img_202.png](assets/processos_snc_ap/img_202.png)


O novo ecrã tem o aspeto abaixo mostrado:

![img_203.png](assets/processos_snc_ap/img_203.png)
...
![img_205.png](assets/processos_snc_ap/img_205.png)
...
![img_206.png](assets/processos_snc_ap/img_206.png)
