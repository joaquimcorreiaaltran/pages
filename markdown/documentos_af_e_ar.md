...
![fluxograma despesa.png](..\markdown\assets\documentos_af_e_ar\fluxograma_despesa.png)
...
![Anulação P2eNc.png](..\markdown\assets\documentos_af_e_ar\Anula%C3%A7%C3%A3o_P2eNc.png)
...
![Anulação de faturas AF.png](..\markdown\assets\documentos_af_e_ar\AF.png)
...
![Image_A.png](..\markdown\assets\documentos_af_e_ar\Image_A.png)

Na impressão, o resultado da Anulação de Faturas deve ser:

![Image_B.png](..\markdown\assets\documentos_af_e_ar\Image_B.png)
...
![fluxograma receita.png](..\markdown\assets\documentos_af_e_ar\fluxograma_receita.png)
...
![anulação FD e CC.png](..\markdown\assets\documentos_af_e_ar\anula%C3%A7%C3%A3o_FD_e_CC.png)
...
![Anulação de Receitas AR.png](..\markdown\assets\documentos_af_e_ar\AR.png)
...
![Encontro_de_Contas](..\markdown\assets\documentos_af_e_ar\Encontro_de_Contas.png)

Na impressão, o resultado da Anulação de Receita ou Anulação de Faturas deve ser:

![resultado_da_impessao](..\markdown\assets\documentos_af_e_ar\resultado_da_impessao.png)

![resultado_da_impessao2](..\markdown\assets\documentos_af_e_ar\resultado_da_impessao2.png)
