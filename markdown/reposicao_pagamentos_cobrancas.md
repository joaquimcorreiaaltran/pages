...
![img_1](https://spmssicc.github.io/pages/markdown/reposicao_pagamentos_cobrancas.assets/img_1.png)
...
![img_2](https://spmssicc.github.io/pages/markdown/reposicao_pagamentos_cobrancas.assets/img_2.png)
...
Desta forma, no menu:
![img_3](https://spmssicc.github.io/pages/markdown/reposicao_pagamentos_cobrancas.assets/img_3.png)

Este mesmo registo de reposição pagamento poderá ser efetuado por uma das seguintes contas: 3\*,4\*,6\* ou 7\*.

![img_4](https://spmssicc.github.io/pages/markdown/reposicao_pagamentos_cobrancas.assets/img_4.png)

![img_5](https://spmssicc.github.io/pages/markdown/reposicao_pagamentos_cobrancas.assets/img_5.png)
...
![img_6](https://spmssicc.github.io/pages/markdown/reposicao_pagamentos_cobrancas.assets/img_6.png)
...
![img_7](https://spmssicc.github.io/pages/markdown/reposicao_pagamentos_cobrancas.assets/img_7.png)
...
![img_8](https://spmssicc.github.io/pages/markdown/reposicao_pagamentos_cobrancas.assets/img_8.png)

**Movimentação Contabilística: Liquidação da RAP (doc. CE)**

![img_9](https://spmssicc.github.io/pages/markdown/reposicao_pagamentos_cobrancas.assets/img_9.png)

Finda a etapa, deve o utilizador confirmar a criação do CE e passar para o nível seguinte:

![img_10](https://spmssicc.github.io/pages/markdown/reposicao_pagamentos_cobrancas.assets/img_10.png)
