...
![img_1](https://spmssicc.github.io/pages/content/html/content/img/markdown_docs/menus/img_1.png)
...
![img_2](https://spmssicc.github.io/pages/content/html/content/img/markdown_docs/menus/img_2.png)
...
![img_3](https://spmssicc.github.io/pages/content/html/content/img/markdown_docs/menus/img_3.png)
...
| Código Postal| Código postal associado à instituição. A lista de códigos postais é acessível através do botão redondo que se encontra entre os campos.<br /> ![img_4](https://spmssicc.github.io/pages/content/html/content/img/markdown_docs/menus/img_4.png)|
...
![img_8](https://spmssicc.github.io/pages/content/html/content/img/markdown_docs/menus/img_8.png)
...
![img_16](https://spmssicc.github.io/pages/content/html/content/img/markdown_docs/menus/img_16.png)

| Campo| Descrição|
|:---|:---|
| Ambiente| Indicar qual o ambiente da aplicação, tendo as seguintes opção disponíveis: <br />![ambiente_desenvolvimento](https://spmssicc.github.io/pages/content/html/content/img/markdown_docs/menus/img_ambiente_desenvolvimento.png)|
...
![img_17](https://spmssicc.github.io/pages/content/html/content/img/markdown_docs/menus/img_17.png)
...
![img_18](https://spmssicc.github.io/pages/content/html/content/img/markdown_docs/menus/img_18.png)
...
![img_19](https://spmssicc.github.io/pages/content/html/content/img/markdown_docs/menus/img_19.png)
...
| Botão| Ação|
|:---|:---|
|"…" <br />![...](https://spmssicc.github.io/pages/content/html/content/img/markdown_docs/menus/img_....png)| Escolher a localização onde pretende guardar a informação a extrair, seja dentro da máquina local ou de uma pasta de rede. O nome do ficheiro é composta pela sigla “LIST_CODPOST_” mais a data de extração, no formato DDMMAAAA ( D – Dia; M – Mês; A – Ano ).|
| Ficheiro| Extrair a informação pretendida para um ficheiro de texto com o formato CSV.|
| Imprimir| Imprimir uma listagem de códigos postal com base nos critérios definidos. O resultado será semelhante ao apresentado:<br />![img_20](https://spmssicc.github.io/pages/content/html/content/img/markdown_docs/menus/img_20.png)|
| Sair| Sair do ecrã.|
...
![img_21](https://spmssicc.github.io/pages/content/html/content/img/markdown_docs/menus/img_21.png)
...
| Critério de filtragem| Critério para filtragem da pesquisa. <br /> ![img_codigo_nome_filtrar](https://spmssicc.github.io/pages/content/html/content/img/markdown_docs/menus/img_codigo_nome_filtrar.png)|
| Critério de posicionamento| Critério a escolher para realçar um resultado da pesquisa. <br /> ![img_posicionar_codigo_nome](https://spmssicc.github.io/pages/content/html/content/img/markdown_docs/menus/img_posicionar_codigo_nome.png)|
...
![img_22](https://spmssicc.github.io/pages/content/html/content/img/markdown_docs/menus/img_22.png)
...
| Ficheiro| Extrair a informação pretendida para um ficheiro de texto com o formato CSV.|
| Imprimir| Imprimir uma listagem de instituições bancárias com base nos critérios definidos. O resultado será semelhante ao apresentado:<br />![img_23](https://spmssicc.github.io/pages/content/html/content/img/markdown_docs/menus/img_23.png)|
| Sair| Sair do ecrã.|
...
![img_24](https://spmssicc.github.io/pages/content/html/content/img/markdown_docs/menus/img_24.png)

| Campo| Descrição|
|:---|:---|
| Critério de filtragem| Critério para filtragem da pesquisa. <br />![codigo_nome](https://spmssicc.github.io/pages/content/html/content/img/markdown_docs/menus/img_codigo_nome.png)|
| Critério de posicionamento| Critério a escolher para realçar um resultado da pesquisa. <br />![codigo_nome](https://spmssicc.github.io/pages/content/html/content/img/markdown_docs/menus/img_codigo_nome.png)|
...
![img_25](https://spmssicc.github.io/pages/content/html/content/img/markdown_docs/menus/img_25.png)
...
| Ficheiro| Extrair a informação pretendida para um ficheiro de texto com o formato CSV.|
| Imprimir| Imprimir uma listagem de fatores de aglutinação com base nos critérios definidos. O resultado será semelhante ao apresentado:<br /> ![img_26](https://spmssicc.github.io/pages/content/html/content/img/markdown_docs/menus/img_26.png)|
| Sair| Sair do ecrã.|
...
![img_27](https://spmssicc.github.io/pages/content/html/content/img/markdown_docs/menus/img_27.png)
...
![img_29](https://spmssicc.github.io/pages/content/html/content/img/markdown_docs/menus/img_28.png)
...
|…| Escolher a localização onde pretende guardar a informação a extrair, seja dentro da máquina local ou de uma pasta de rede. O nome do ficheiro é composta pela sigla “LIST_FACAGLU_” mais a data de extração, no formato DDMMAAAA ( D – Dia; M – Mês; A – Ano ).|
| Ficheiro| Extrair a informação pretendida para um ficheiro de texto com o formato CSV.|
| Imprimir| Imprimir uma listagem de tipos de entidades com base nos critérios definidos. O resultado será semelhante ao apresentado:<br />![img_29](https://spmssicc.github.io/pages/content/html/content/img/markdown_docs/menus/img_29.png)|
| Sair| Sair do ecrã.|
...
![img_30](https://spmssicc.github.io/pages/content/html/content/img/markdown_docs/menus/img_30.png)
...
![img_31](https://spmssicc.github.io/pages/content/html/content/img/markdown_docs/menus/img_31.png)
...
| Ficheiro| Extrair a informação pretendida para um ficheiro de texto com o formato CSV.|
| Imprimir| Imprimir uma listagem de instituições bancárias com base nos critérios definidos. O resultado final será semelhante ao apresentado:<br /> ![img_32](https://spmssicc.github.io/pages/content/html/content/img/markdown_docs/menus/img_32.png)|
| Sair| Sair do ecrã.|
...
![img_33](https://spmssicc.github.io/pages/content/html/content/img/markdown_docs/menus/img_33.png)
...
![img_34](https://spmssicc.github.io/pages/content/html/content/img/markdown_docs/menus/img_34.png)
...
![img_35](https://spmssicc.github.io/pages/content/html/content/img/markdown_docs/menus/img_35.png)
...
| Tipo de Orçamento| Nesta área é apresentado qual ou quais os tipos de orçamento a que a conta pertence. Na inserção de uma nova conta, o utilizador deve marcar os registo que interessam. <br />![tipo_de_orcamento](https://spmssicc.github.io/pages/content/html/content/img/markdown_docs/menus/img_tipo_de_orcamento.png)|
...
| Receita / Despesa| Informação relativa à conta analítica, indicando se é uma conta de despesa ou de receita. Na inserção de uma nova conta, o utilizador deve marcar a opção correta. <br />![receita_despesa](https://spmssicc.github.io/pages/content/html/content/img/markdown_docs/menus/img_receita_despesa.png)|
...
![img_37](https://spmssicc.github.io/pages/content/html/content/img/markdown_docs/menus/img_37.png)
...
| Ficheiro| Extrair a informação pretendida para um ficheiro de texto com o formato CSV.|
| Imprimir| Imprimir uma listagem de contas com base nos critérios definidos. O resultado final será semelhante ao apresentado:<br />![img_38](https://spmssicc.github.io/pages/content/html/content/img/markdown_docs/menus/img_38.png)|
| Sair| Sair do ecrã.|
...
![img_39](https://spmssicc.github.io/pages/content/html/content/img/markdown_docs/menus/img_39.png)

| Campo| Descrição|
|:---|:---|
| Exercício| Listagem de exercícios disponíveis conforme o Plano de Contas. Neste campo o utilizador pode escolher o exercício e apenas verá as informações das contas registadas para esse ano. Caso o utilizador pretenda inserir uma nova conta, deve indicar neste campo a qual a exercício que pertence. <br />![img_2015_ano](https://spmssicc.github.io/pages/content/html/content/img/markdown_docs/menus/img_2015_ano.png)|
| Critério de posicionamento|  Critério a escolher para realçar um resultado da pesquisa. O utilizador pode escolher uma conta e após carregar no botão, o registo atual passa a ser aquele que o utilizador identificou.<br />![img_40](https://spmssicc.github.io/pages/content/html/content/img/markdown_docs/menus/img_40.png)|
| Critério de filtragem| Critério para filtragem da pesquisa. Permite ao utilizador, mediante os critérios de pesquisa disponíveis, efetuar consultas aos dados(contas). Os critérios disponíveis são os indicados na imagem.<br />![img_41](https://spmssicc.github.io/pages/content/html/content/img/markdown_docs/menus/img_41.png)|
| Código| Esta informação, está dividida em dois campos. O primeiro indica o número da conta, conforme aparece na listagem. E o segundo, apresenta o descritivo dessa mesma conta.<br />![receitas_correntes_e_de_capital](https://spmssicc.github.io/pages/content/html/content/img/markdown_docs/menus/img_receitas_correntes_e_de_capital.png)|
| Tipo de Movimento| Indicação do tipo de movimento: despesa ou receita.<br />![despesa_despesa](https://spmssicc.github.io/pages/content/html/content/img/markdown_docs/menus/img_despesa_despesa.png)|
| Tipo de Conta| Indicação do tipo de conta. <br />![tipo_acumulacao](https://spmssicc.github.io/pages/content/html/content/img/markdown_docs/menus/img_tipo_acumulacao.png)|
| Conta Acumulação| Esta informação, está dividida em dois campos. O primeiro indica o número da conta de acumulação a que pertence a conta selecionada, conforme aparece na listagem. E o segundo, apresenta o descritivo dessa mesma conta.|
...
![img_42](https://spmssicc.github.io/pages/content/html/content/img/markdown_docs/menus/img_42.png)
...
| Ficheiro| Extrair a informação pretendida para um ficheiro de texto com o formato CSV.|
| Imprimir| Imprimir uma listagem de contas com base nos critérios definidos. O resultado final será semelhante ao apresentado:<br />![img_43](https://spmssicc.github.io/pages/content/html/content/img/markdown_docs/menus/img_43.png)|
| Sair| Sair do ecrã.|
...
![img_44](https://spmssicc.github.io/pages/content/html/content/img/markdown_docs/menus/img_44.png)
...
![img_45](https://spmssicc.github.io/pages/content/html/content/img/markdown_docs/menus/img_45.png)
...
![img_46](https://spmssicc.github.io/pages/content/html/content/img/markdown_docs/menus/img_46.png)
...
![img_47](https://spmssicc.github.io/pages/content/html/content/img/markdown_docs/menus/img_47.png)
...
![img_48](https://spmssicc.github.io/pages/content/html/content/img/markdown_docs/menus/img_48.png)
...
![img_49](https://spmssicc.github.io/pages/content/html/content/img/markdown_docs/menus/img_49.png)
...
![img_50](https://spmssicc.github.io/pages/content/html/content/img/markdown_docs/menus/img_50.png)
...
![img_52](https://spmssicc.github.io/pages/content/html/content/img/markdown_docs/menus/img_52.png)
...
| Ficheiro| Extrair a informação pretendida para um ficheiro de texto com o formato CSV.
| Imprimir| Imprimir uma listagem de tipos de diário com base nos critérios definidos. O resultado final será semelhante ao apresentado:<br />![img_53](https://spmssicc.github.io/pages/content/html/content/img/markdown_docs/menus/img_53.png)|
| Sair| Sair do ecrã.|
...
| Tipo| Este campo indica o tipo de centro de custo.<br />![acumulacao_movimento](https://spmssicc.github.io/pages/content/html/content/img/markdown_docs/menus/img_acumulacao_movimento.png)|
...
![img_55](https://spmssicc.github.io/pages/content/html/content/img/markdown_docs/menus/img_55.png)
...
| Ficheiro| Extrair a informação pretendida para um ficheiro de texto com o formato CSV.|
| Imprimir| Imprimir uma listagem de centros de custos com base nos critérios definidos. O resultado final será semelhante ao apresentado:![img_56](https://spmssicc.github.io/pages/content/html/content/img/markdown_docs/menus/img_56.png)|
| Sair| Sair do ecrã.|
...
![img_58](https://spmssicc.github.io/pages/content/html/content/img/markdown_docs/menus/img_58.png)
...
![img_59](https://spmssicc.github.io/pages/content/html/content/img/markdown_docs/menus/img_59.png)
...
![img_60](https://spmssicc.github.io/pages/content/html/content/img/markdown_docs/menus/img_60.png)
...
| Intragrupo| Este campos indica se a entidade é intragrupo ou não. Caso seja, é apresentado um campo com o descritivo do intragrupo.<br />![intragrupo](https://spmssicc.github.io/pages/content/html/content/img/markdown_docs/menus/img_intragrupo.png)|
| Entidade Parceira| Este campos indica se a entidade é uma entidade parceira ou não. Caso seja, é apresentado um campo com o descritivo da entidade parceira.<br />![entidade_parceira](https://spmssicc.github.io/pages/content/html/content/img/markdown_docs/menus/img_entidade_parceira.png)|
| Tipo de Entidade| Identificação do tipo de entidade. Na inserção ou alteração de um registo, o utilizador carregando no círculo ![radio](https://spmssicc.github.io/pages/content/html/content/img/markdown_docs/menus/img_radio.png) entre o campo de código e descritivo pode obter uma listagem de todos os tipos de entidades disponíveis.|
...
| País| País da entidade. Na inserção ou alteração de um registo, o utilizador carregando no círculo ![radio](https://spmssicc.github.io/pages/content/html/content/img/markdown_docs/menus/img_radio.png) entre o campo de código e descritivo pode obter uma listagem de todos os países disponíveis.|
...
|(Entidade) – Tipo| Tipo de número de conta bancária: <br /> - NIB : Numero de Identificação Bancária; <br /> - IBAN : Número Internacional de Conta Bancária.<br />![tipo_nib](https://spmssicc.github.io/pages/content/html/content/img/markdown_docs/menus/img_tipo_nib.png)|
...
![img_61](https://spmssicc.github.io/pages/content/html/content/img/markdown_docs/menus/img_61.png)

| Campo| Descrição|
|:---|:---|
| Critério de filtragem| Critério para filtragem da pesquisa. Permite ao utilizador, mediante os critérios de pesquisa disponíveis, efetuar consultas aos dados.<br />![codigo_de_entidade](https://spmssicc.github.io/pages/content/html/content/img/markdown_docs/menus/img_codigo_de_entidade.png)|
| Critério de posicionamento| Critério a escolher para realçar um resultado da pesquisa. O utilizador pode escolher um NIF e após carregar no botão, o registo atual passa a ser aquele que o utilizador identificou.<br />![posicionar_num_contribuinte](https://spmssicc.github.io/pages/content/html/content/img/markdown_docs/menus/img_posicionar_num_contribuinte.png)|
| Nº de Contribuinte| Número de identificação fiscal da entidade.|
...
![img_63](https://spmssicc.github.io/pages/content/html/content/img/markdown_docs/menus/img_63.png)
...
![img_64](https://spmssicc.github.io/pages/content/html/content/img/markdown_docs/menus/img_64.png)
...
![img_65](https://spmssicc.github.io/pages/content/html/content/img/markdown_docs/menus/img_65.png)
...
![img_66](https://spmssicc.github.io/pages/content/html/content/img/markdown_docs/menus/img_66.png)
...
| Email| Endereço de correio eletrónico da entidade.|
| Nº de Contribuinte| Número de identificação fiscal da entidade.|
|(Entidade *Factoring*) – Tipo| Tipo de número de conta bancária:<br />- NIB : Numero de Identificação Bancária;<br />- IBAN : Número Internacional de Conta Bancária.<br />![tipo_nib](https://spmssicc.github.io/pages/content/html/content/img/markdown_docs/menus/img_tipo_nib.png)|
...
![img_67](https://spmssicc.github.io/pages/content/html/content/img/markdown_docs/menus/img_67.png)
...
![img_68](https://spmssicc.github.io/pages/content/html/content/img/markdown_docs/menus/img_68.png)
...
![img_69](https://spmssicc.github.io/pages/content/html/content/img/markdown_docs/menus/img_69.png)

<a name="op_sair"></a>

## Sair

![img_70](https://spmssicc.github.io/pages/content/html/content/img/markdown_docs/menus/img_70.png)
...
![img_71](https://spmssicc.github.io/pages/content/html/content/img/markdown_docs/menus/img_71.png)
...
![img_72](https://spmssicc.github.io/pages/content/html/content/img/markdown_docs/menus/img_72.png)

| Campo| Descrição|
|:---|:---|
| Tipo| Este campo permite ao utilizador efetuar a pesquisa de entidades, através do código da mesma ou do respectivo número de contribuinte.<br />![posicionar_num_contribuinte](https://spmssicc.github.io/pages/content/html/content/img/markdown_docs/menus/img_posicionar_num_contribuinte.png)|
...
| Exercício| O utilizador tem de obrigatoriamente escolher para qual o exercício que pretende obter a informação, sendo por defeito escolhido o período corrente.<br />![exercicio_2015](https://spmssicc.github.io/pages/content/html/content/img/markdown_docs/menus/img_exercicio_2015.png)|
...
| Ficheiro| Extrair a informação pretendida para um ficheiro de texto com o formato CSV.
| Imprimir| Imprimir uma listagem de entidades com base nos critérios definidos. O resultado final do documento será semelhante ao apresentado:<br />![img_73](https://spmssicc.github.io/pages/content/html/content/img/markdown_docs/menus/img_73.png)|
| Email|  enviar informação acerca das entidades por email. Ao carregar no mesmo é apresentado o seguinte ecrã:<br />![img_74](https://spmssicc.github.io/pages/content/html/content/img/markdown_docs/menus/img_74.png) <br /><br />Neste ecrã o utilizador deve escolher os critérios de selecção para gerar os dados a enviar por email, nomeadamente:<br /> <br />- Exercício;<br /> <br />- Data de Referência;<br /> <br />- Número da primeira entidade;<br /> <br />- Número da última entidade;<br /> <br />- Tipo de informação pretendida: Conta Corrente, Notas de Encomenda, Autorizações de pagamento ou Faturas em Conferencia/Recepção.<br /><br /> Para calcular a informação a enviar, por email, o utilizador deve carregar no botão Calcular. O resultado dos cálculos aparecerá no ecrã. ![calcular](https://spmssicc.github.io/pages/content/html/content/img/markdown_docs/menus/img_calcular.png)<br />Antes de proceder ao envio do email, o utilizador deve indicar a pasta onde será gravado temporariamente o ficheiro a enviar em anexo à mensagem. ![img_mail_29092015.csv](https://spmssicc.github.io/pages/content/html/content/img/markdown_docs/menus/img_mail_29092015.csv.png). <br />Para confirmar o envio do documento, o utilizador deve carregar no botão Ficheiro de Mails. ![ficheiro_de_mails](https://spmssicc.github.io/pages/content/html/content/img/markdown_docs/menus/img_ficheiro_de_mails.png). <br />Para sair do ecrã o utilizador deve carregar no botão Sair.<br /> ![sair](https://spmssicc.github.io/pages/content/html/content/img/markdown_docs/menus/img_sair.png)|
| Sair| Sair do ecrã.|

#### Tabulação – Conta Corrente

![img_75](https://spmssicc.github.io/pages/content/html/content/img/markdown_docs/menus/img_75.png)
...
![img_76](https://spmssicc.github.io/pages/content/html/content/img/markdown_docs/menus/img_76.png)
...
![img_77](https://spmssicc.github.io/pages/content/html/content/img/markdown_docs/menus/img_77.png)
...
![img_78](https://spmssicc.github.io/pages/content/html/content/img/markdown_docs/menus/img_78.png)
...
![img_79](https://spmssicc.github.io/pages/content/html/content/img/markdown_docs/menus/img_79.png)
...
![img_80](https://spmssicc.github.io/pages/content/html/content/img/markdown_docs/menus/img_80.png)
...
| Botão| Ação|
|:---|:---|
| Ficheiro| Extrair a informação pretendida para um ficheiro de texto com o formato CSV. O utilizador deve indicar a localização onde o ficheiro será guardado através do seguinte botão:<br />![...](https://spmssicc.github.io/pages/content/html/content/img/markdown_docs/menus/img_....png)|


#### Tabulação – Compromisso Assumido/Proc. Aquisição

![img_81](https://spmssicc.github.io/pages/content/html/content/img/markdown_docs/menus/img_81.png)
...
![img_82](https://spmssicc.github.io/pages/content/html/content/img/markdown_docs/menus/img_82.png)
...
![img_83](https://spmssicc.github.io/pages/content/html/content/img/markdown_docs/menus/img_83.png)
...
| Botão| Ação|
|:---|:---|
| Calcular| Obter o mapa de gestão com base nos critérios indicados pelo utilizador. <br />![img_84](https://spmssicc.github.io/pages/content/html/content/img/markdown_docs/menus/img_84.png)|
| Imprimir| Extrair a informação pretendida para um ficheiro de relatório com o formato PDF.<br />![img_85](https://spmssicc.github.io/pages/content/html/content/img/markdown_docs/menus/img_85.png)|
...
![img_86](https://spmssicc.github.io/pages/content/html/content/img/markdown_docs/menus/img_86.png)
...
| Botão| Ação|
|:---|:---|
| Calcular| Obter o mapa de gestão com base nos critérios indicados pelo utilizador.<br />![img_88](https://spmssicc.github.io/pages/content/html/content/img/markdown_docs/menus/img_88.png)|
| Ficheiro CSV| Extrair a informação pretendida para um ficheiro de texto com o formato CSV. O utilizador deve indicar a localização onde o ficheiro será guardado através do seguinte botão: sendo o ficheiro guardado na localização indicada em: O nome do ficheiro será GTFTDATA.|
| Imprimir| Extrair a informação pretendida para um ficheiro de relatório com o formato PDF.<br />![img_89](https://spmssicc.github.io/pages/content/html/content/img/markdown_docs/menus/img_89.png)|
| Sair| Sair do ecrã atual e voltar ao menu principal.|
