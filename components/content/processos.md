...
![img_1.png](Ficheiros_de_suporte/Processos/img_1.png)
...
![img_2.png](Ficheiros_de_suporte/Processos/img_2.png)
...
|Orçamento Ordinário|Seleção apenas se for a introdução de um orçamento ordinário ![img_orç_ordinario.png](Ficheiros_de_suporte/Processos/img_orç_ordinario.png) |Todos|
|Alteração Orçamental|Seleção apenas se for uma alteração orçamental a registar. Ao selecionar, automaticamente aparece o número de lançamento o qual se pretende alterar. ![img_alteracao_orc_num_lancamento.png](Ficheiros_de_suporte/Processos/img_alteracao_orc_num_lancamento.png) |Todos|
|Atividade/Departamento|Identificação do tipo de Atividade/Departamento. Na seleção do botão de ajuda, o utilizador carregando no círculo ![img_radio_unselected.png](Ficheiros_de_suporte/Processos/img_radio_unselected.png) pode obter uma listagem de todos os tipos de Atividades/Departamentos.|Todos|
|Data|---?---|Todos|
...
![img_3.png](Ficheiros_de_suporte/Processos/img_3.png)

Importante referir que o botão ![desdobrar_conta.png](Ficheiros_de_suporte/Processos/img_desdobrar_conta.png), permite desdobrar os classificadores económicos e permite o registo de diferentes chaves orçamentais.
Ao clicar no ![confirme.png](Ficheiros_de_suporte/Processos/img_confirme.png), o sistema criará assim de forma automática um novo ecrã, com a criação da PO.
O utilizador tem de proceder à aprovação, através do botão ![aprovar.png](Ficheiros_de_suporte/Processos/img_aprovar.png). Assim dá indicação ao sistema que os valores anteriormente carregados, fazem parte do orçamento ordinário.

![img_4.png](Ficheiros_de_suporte/Processos/img_4.png)
...
![img_5.png](Ficheiros_de_suporte/Processos/img_5.png)
...
![img_6png](Ficheiros_de_suporte/Processos/img_6.png)
...
![img_7.png](Ficheiros_de_suporte/Processos/img_7.png)
...
![img_10.png](Ficheiros_de_suporte/Processos/img_10.png)
...
![img_7a.png](Ficheiros_de_suporte/Processos/img_7a.png)
...
![img_8a.png](Ficheiros_de_suporte/Processos/img_8a.png)
...
![img_9a.png](Ficheiros_de_suporte/Processos/img_9a.png)
...
![img_12.png](Ficheiros_de_suporte/Processos/img_12.png)

![img_13.png](Ficheiros_de_suporte/Processos/img_13.png)
...
![img_14.png](Ficheiros_de_suporte/Processos/img_14.png)

![img_15.png](Ficheiros_de_suporte/Processos/img_15.png)

![img_16.png](Ficheiros_de_suporte/Processos/img_16.png)

![img_17.png](Ficheiros_de_suporte/Processos/img_17.png)

![img_18.png](Ficheiros_de_suporte/Processos/img_18.png)

![img_19.png](Ficheiros_de_suporte/Processos/img_19.png)

![img_20.png](Ficheiros_de_suporte/Processos/img_20.png)

![img_21.png](Ficheiros_de_suporte/Processos/img_21.png)

![img_22.png](Ficheiros_de_suporte/Processos/img_22.png)

![img_23.png](Ficheiros_de_suporte/Processos/img_23.png)

No final de cada mês, o utilizador ao Confirmar, surge no ecrã a indicação de:

![img_24.png](Ficheiros_de_suporte/Processos/img_24.png)
...
![img_25.png](Ficheiros_de_suporte/Processos/img_25.png)
...
![img_28.png](Ficheiros_de_suporte/Processos/img_28.png)

#### Criação com fundos disponíveis

![img_29.png](Ficheiros_de_suporte/Processos/img_29.png)

#### Geração de movimentos contabilísticos e confirmação

![img_30.png](Ficheiros_de_suporte/Processos/img_30.png)
...
![img_31.png](Ficheiros_de_suporte/Processos/img_31.png)
...
|Mapa|Este botão permite ao utilizador consultar diretamente o mapa no ecrã. ![img_32.png](Ficheiros_de_suporte/Processos/img_32.png)|
|Sair|Este botão permite ao utilizador sair do ecrã corrente.|
...
|:----|:---------|:---------|
|Ano|Exercício a que dizem respeito as informação da instituição.|Todos|
|Mês|Seleção do mês para carregamento dos fundos. ![img_mes_janeiro.png](Ficheiros_de_suporte/Processos/img_mes_janeiro.png)|Todos|
|Diretório|Este botão permite ao utilizador escolher o diretório de gravação do Excel que irá ser produzido. ![img_33.png](Ficheiros_de_suporte/Processos/img_33.png)|Todos|
...
![img_34.png](Ficheiros_de_suporte/Processos/img_34.png)
...
|Extrato|Este botão permite a gravar alterações que no diretório escolhido pelo utilizador.|
|XML|Esta opção permite a produção do mapa em ficheiro com extensão XML.|
|Mapa|Este botão permite ao utilizador consultar diretamente o mapa no ecrã. ![img_35.png](Ficheiros_de_suporte/Processos/img_35.png)|
|Sair|Este botão permite ao utilizador sair do ecrã corrente.|
...
|Ano|Exercício a que dizem respeito as informação da instituição.|Todos|
|Mês|Seleção do mês para carregamento dos fundos. ![img_mes_janeiro.png](Ficheiros_de_suporte/Processos/img_mes_janeiro.png)|Todos|
|Diretório|Este botão permite ao utilizador escolher o diretório de gravação do Excel que irá ser produzido. ![img_36.png](Ficheiros_de_suporte/Processos/img_36.png)|Todos|
...
![img_37.png](Ficheiros_de_suporte/Processos/img_37.png)
...
![img_38.png](Ficheiros_de_suporte/Processos/img_38.png)

|Campo|Obrigatoriedade|Descritivo|
|:----|:---------|:---------|
|Exercício|Obrigatório|Exercício a que dizem respeito as informação da instituição.|
|Proposta|Obrigatório|Seleção de um dos campos: ![img_39.png](Ficheiros_de_suporte/Processos/img_39.png)|
|Orçamento|Obrigatório|Seleção de um dos campos: ![img_40.png](Ficheiros_de_suporte/Processos/img_40.png) __Ao selecionar a “Alteração Orçamental”, surge automaticamente para preenchimento: ![img_41.png](Ficheiros_de_suporte/Processos/img_41.png) |
|Financiamento|Obrigatório|Seleção de um dos campos: ![img_42.png](Ficheiros_de_suporte/Processos/img_42.png)|
|Atividades/Departamento|Obrigatório|Seleção de um dos campos: ![img_43.png](Ficheiros_de_suporte/Processos/img_43.png)|
|Pri. Data|Obrigatório||
|Últ. Data|Obrigatório||

|Botão|Descritivo|
|:----|:---------|
|Ficheiro|Este botão permite ao utilizador escolher o diretório de gravação do Excel que irá ser produzido. ![img_44.png](Ficheiros_de_suporte/Processos/img_44.png) ![img_45.png](Ficheiros_de_suporte/Processos/img_45.png)|
...
![img_46.png](Ficheiros_de_suporte/Processos/img_46.png)
...
![img_47.png](Ficheiros_de_suporte/Processos/img_47.png)
...
![img_48.png](Ficheiros_de_suporte/Processos/img_48.png)
...
![img_49.png](Ficheiros_de_suporte/Processos/img_49.png)
...
![img_50.png](Ficheiros_de_suporte/Processos/img_50.png)
...
![img_51.png](Ficheiros_de_suporte/Processos/img_51.png)
...
![img_52.png](Ficheiros_de_suporte/Processos/img_52.png)

|Campo|Obrigatoriedade|Descritivo|
|:---|:---|:---|
|Exercício|Obrigatório|Exercício a que dizem respeito as informação da instituição.|
|Proposta|Obrigatório|Seleção de um dos campos: ![img_valores_proposta_orcamental.png](Ficheiros_de_suporte/Processos/img_valores_proposta_orcamental.png)|
|Orçamento|Obrigatório|Seleção de um dos campos: ![img_alteracao_orcamental.png](Ficheiros_de_suporte/Processos/img_alteracao_orcamental.png) __Ao selecionar a “Alteração Orçamental”, surge automaticamente para preenchimento: ![img_num_alt_orcamental.png](Ficheiros_de_suporte/Processos/img_num_alt_orcamental.png)|
|Financiamento|Obrigatório|Seleção de um dos campos: ![img_56.png](Ficheiros_de_suporte/Processos/img_56.png)|
|Atividades/Departamento|Obrigatório|Seleção de um dos campos: ![img_57.png](Ficheiros_de_suporte/Processos/img_57.png)|
|Pri. Data|Obrigatório|Definir a data de início da pesquisa.|
|Últ. Data|Obrigatório|Definir a data final da pesquisa.|

|Botão|Descritivo|
|:---|:---|
|Ficheiro|Este botão permite ao utilizador escolher o diretório de gravação do Excel que irá ser produzido.![img_57a.png](Ficheiros_de_suporte/Processos/img_57a.png) ![img_57b.png](Ficheiros_de_suporte/Processos/img_57b.png)|
|Imprimir|Este botão permite que o utilizador gere relatório diretamente no ecrã.|
|Sair|Este botão permite que o utilizador saia do ecrã e regresse ao menu inicial.|

O exemplo seguinte, demonstra um relatório de alteração orçamental gerada em passos anteriores, evidenciando os respetivos itens financeiros e respetivos valores.

![img_54.png](Ficheiros_de_suporte/Processos/img_54.png)
...
![img_55.png](Ficheiros_de_suporte/Processos/img_55.png)
...
![img_56.png](Ficheiros_de_suporte/Processos/img_56.png)

Ao selecionar Cabimentos/Compromissos, irá surgir o seguinte ecrã:

![img_57.png](Ficheiros_de_suporte/Processos/img_57.png)
...
![img_58.png](Ficheiros_de_suporte/Processos/img_58.png)
...
![img_59.png](Ficheiros_de_suporte/Processos/img_59.png)

A gravação do CB abre novo ecrã, onde teremos um botão de ajuda no preenchimento dos seguintes campos obrigatórios:

![img_60.png](Ficheiros_de_suporte/Processos/img_60.png)

|Campo|Obrigatoriedade|Descritivo|
|:----|:--------------|:---------|
|Classificador Económico|Obrigatório|Seleção do classificador económico a associar ao Cabimento. ![img_61.png](Ficheiros_de_suporte/Processos/img_61.png)|
|Conta|Obrigatório|Seleção da conta ao classificador. ![img_62.png](Ficheiros_de_suporte/Processos/img_62.png)|
...
![img_63.png](Ficheiros_de_suporte/Processos/img_63.png)
...
![img_64.png](Ficheiros_de_suporte/Processos/img_64.png)
...
![img_65.png](Ficheiros_de_suporte/Processos/img_65.png)
...
![img_66.png](Ficheiros_de_suporte/Processos/img_66.png)
...
![img_67.png](Ficheiros_de_suporte/Processos/img_67.png)
...
![img_68.png](Ficheiros_de_suporte/Processos/img_68.png)
...
![img_importacao_concluida_sucesso.png](Ficheiros_de_suporte/Processos/img_importacao_concluida_sucesso.png)
...
![img_69.png](Ficheiros_de_suporte/Processos/img_69.png)

O utilizador ao escolher um dos seguintes botões obtém os ecrãs:

#### Informação de CB

![img_70.png](Ficheiros_de_suporte/Processos/img_70.png)

O utilizador ao pressionar o botão "Imprimir", gera no ecrã o resultado da criação do CB.

![img_72.png](Ficheiros_de_suporte/Processos/img_72.png)

#### Listagens de CB

![img_74.png](Ficheiros_de_suporte/Processos/img_74.png)

Nos ecrãs atrás referidos, o procedimento é similar:

|Botão|Descritivo|
|:---|:---|
|Calcular|Este botão permite o resumo do que foi criado no cabimento. ![img_75.png](Ficheiros_de_suporte/Processos/img_75.png)|
|Imprimir|Este botão permite que o utilizador gere relatório diretamente no ecrã.|
|Ficheiro|Este botão permite ao utilizador escolher o diretório de gravação do Excel que irá ser produzido. ![img_76.png](Ficheiros_de_suporte/Processos/img_76.png)|
|Sair|Este botão permite que o utilizador saia do ecrã e regresse ao menu inicial.|

O formato na opção "Imprimir", é o seguinte:

![img_77.png](Ficheiros_de_suporte/Processos/img_77.png)
...
![img_78.png](Ficheiros_de_suporte/Processos/img_78.png)
...
![img_79.png](Ficheiros_de_suporte/Processos/img_79.png)
...
![img_80.png](Ficheiros_de_suporte/Processos/img_80.png)
...
![img_81.png](Ficheiros_de_suporte/Processos/img_81.png)

O novo ecrã surge e associada a ela, aparecem os movimentos de lançamento do cabimento. Se os lançamentos estiverem corretos, deve o utilizador confirmar, pressionado o botão de confirmação.

![img_82.png](Ficheiros_de_suporte/Processos/img_82.png)

A alteração ao Cabimento acaba de ser efetuada, sendo que o sistema gera uma mensagem de confirmação.

![img_83.png](Ficheiros_de_suporte/Processos/img_83.png)
...
![img_84.png](Ficheiros_de_suporte/Processos/img_84.png)

Ao pressionar, o utilizador vai deparar-se com o seguinte ecrã, sendo que para carregamento do ficheiro, tem de escolher o Diretório de Origem.

![img_85.png](Ficheiros_de_suporte/Processos/img_85.png)

O aspeto do ficheiro CSV. é o abaixo demonstrado, sendo que o mesmo deve obedecer ao critério das colunas estipuladas, para efeito de carregamento.

![img_86.png](Ficheiros_de_suporte/Processos/img_86.png)
...
![img_87.png](Ficheiros_de_suporte/Processos/img_87.png)
...
![img_88.png](Ficheiros_de_suporte/Processos/img_88.png)
...
![img_91.png](Ficheiros_de_suporte/Processos/img_91.png)
...
![img_94.png](Ficheiros_de_suporte/Processos/img_94.png)

Neste ecrã, surge o resumo da criação efetuada no passo anterior

![img_95.png](Ficheiros_de_suporte/Processos/img_95.png)
...
![img_95a.png](Ficheiros_de_suporte/Processos/img_95a.png)

O utilizador ao pressionar o botão "Imprimir", gera no ecrã o resultado da criação do CM.

![img_95b.png](Ficheiros_de_suporte/Processos/img_95b.png)
...
![img_96.png](Ficheiros_de_suporte/Processos/img_96.png)

Ao pressionar, o utilizador vai deparar-se com o seguinte ecrã, sendo que para carregamento do ficheiro, tem de escolher o Diretório de Origem.

![img_96a.png](Ficheiros_de_suporte/Processos/img_96a.png)

O aspeto do ficheiro CSV. é o abaixo demonstrado, sendo que o mesmo deve obedecer ao critério das colunas estipuladas, para efeito de carregamento.

![img_97.png](Ficheiros_de_suporte/Processos/img_97.png)
...
![img_98.png](Ficheiros_de_suporte/Processos/img_98.png)

Após validação dos elementos integrados e constatado que os valores estão coerentes com o ficheiro integrado, o utilizador deve assim usar o botão "Importa Ligação". Depois de pressionar e de forma automática, o sistema gera uma mensagem de confirmação, com a indicação abaixo discrita.

![img_98a.png](Ficheiros_de_suporte/Processos/img_98a.png)
...
![img_99.png](Ficheiros_de_suporte/Processos/img_99.png)
...
![img_100.png](Ficheiros_de_suporte/Processos/img_100.png)

Ao pressionar, o utilizador vai deparar-se com o seguinte ecrã, sendo que para carregamento do ficheiro, tem de escolher o Diretório de Origem.

![img_101.png](Ficheiros_de_suporte/Processos/img_101.png)

O aspeto do ficheiro CSV. é o abaixo demonstrado, sendo que o mesmo deve obedecer ao critério das colunas estipuladas, para efeito de carregamento.

![img_102.png](Ficheiros_de_suporte/Processos/img_102.png)

Antes da importação,o utilizador, tem de usar o botão "Ver/Testar Ficheiro". Ao pressionar este mesmo botão, o utilizador constata que os elementos do ficheiro CSV estão visíveis e que o ficheiro integrado está testado. Caso ocorram erros, os mesmos produzem um relatório no ecrã, na caixa criada para o efeito, no canto inferior direito do ecrã.

![img_104.png](Ficheiros_de_suporte/Processos/img_104.png)
...
![img_105.png](Ficheiros_de_suporte/Processos/img_105.png)
...
![img_106.png](Ficheiros_de_suporte/Processos/img_106.png)

O utilizador neste ecrã e no primeiro separador, deve indicar o nº do compromisso. De forma automática, o sistema gera a data de criação do documento, a conta financeira associada e o respetivo montante. A fase seguinte é a de definir a entidade. Para o efeito deve pressionar sobre o botão "![img_radio_unselected.png](Ficheiros_de_suporte/Processos/img_radio_unselected.png)" para chamada de todas as entidades registadas na base de dados.

![img_107.png](Ficheiros_de_suporte/Processos/img_107.png)
...
![img_111.png](Ficheiros_de_suporte/Processos/img_111.png)
...
![img_112.png](Ficheiros_de_suporte/Processos/img_112.png)
...
![img_113.png](Ficheiros_de_suporte/Processos/img_113.png)

Ao gerar os documentos na contabilidade, não esquecer que na analítica terá de ser atribuído um centro de custo para as contas classe 6. Através do botão "![img_radio_unselected.png](Ficheiros_de_suporte/Processos/img_radio_unselected.png)", o utilizador tem acesso a todos os centros de custo inseridos em sistema.

![img_114.png](Ficheiros_de_suporte/Processos/img_114.png)
...
![img_117.png](Ficheiros_de_suporte/Processos/img_117.png)

Ao pressionar, o utilizador vai deparar-se com o seguinte ecrã, sendo que para carregamento do ficheiro, tem de escolher o Diretório de Origem.

![img_118.png](Ficheiros_de_suporte/Processos/img_118.png)

O aspeto do ficheiro CSV. é o abaixo demonstrado, sendo que o mesmo deve obedecer ao critério das colunas estipuladas, para efeito de carregamento.

![img_119.png](Ficheiros_de_suporte/Processos/img_119.png)

Antes da importação,o utilizador, tem de usar o botão "Ver/Testar Ficheiro". Ao pressionar este mesmo botão, o utilizador constata que os elementos do ficheiro CSV estão visíveis e que o ficheiro integrado está testado. Caso ocorram erros, os mesmos produzem um relatório no ecrã, na caixa criada para o efeito, no canto inferior direito do ecrã.

![img_120.png](Ficheiros_de_suporte/Processos/img_120.png)
...
![img_121.png](Ficheiros_de_suporte/Processos/img_121.png)
...
![img_122.png](Ficheiros_de_suporte/Processos/img_122.png)

Ao pressionar, o utilizador vai deparar-se com o seguinte ecrã, sendo que para carregamento do ficheiro, tem de escolher o Diretório de Origem.

![img_123.png](Ficheiros_de_suporte/Processos/img_123.png)

O aspeto do ficheiro CSV. é o abaixo demonstrado, sendo que o mesmo deve obedecer ao critério das colunas estipuladas, para efeito de carregamento.

![img_124.png](Ficheiros_de_suporte/Processos/img_124.png)

Antes da importação,o utilizador, tem de usar o botão "Verificar Ficheiro". Ao pressionar este mesmo botão, o utilizador constata que os elementos do ficheiro CSV estão visíveis e que o ficheiro integrado está testado. Caso ocorram erros, os mesmos produzem um relatório no ecrã, na caixa criada para o efeito, no canto inferior direito do ecrã.


![img_125.png](Ficheiros_de_suporte/Processos/img_125.png)
...
![img_126.png](Ficheiros_de_suporte/Processos/img_126.png)
...
![img_127.png](Ficheiros_de_suporte/Processos/img_127.png)
...
![img_128.png](Ficheiros_de_suporte/Processos/img_128.png)
...
![img_129.png](Ficheiros_de_suporte/Processos/img_129.png)
...
![img_130.png](Ficheiros_de_suporte/Processos/img_130.png)
...
![img_131.png](Ficheiros_de_suporte/Processos/img_131.png)
...
![img_132.png](Ficheiros_de_suporte/Processos/img_132.png)
...
![img_133.png](Ficheiros_de_suporte/Processos/img_133.png)

|Campo|Descritivo|
|:---|:---|
|NIB/IBAN|Este campo dá a hipótese do utilizador escolher se é um NIB ou um IBAN, aparecendo as seguintes opções: ![img_nib_credor.png](Ficheiros_de_suporte/Processos/img_nib_credor.png)|
|Motivo|O motivo deverá igualmente ser escolhido dentro das parametrizações inseridas em sistema: ![img_secu_pag_igcp.png](Ficheiros_de_suporte/Processos/img_secu_pag_igcp.png)|
...
![img_134.png](Ficheiros_de_suporte/Processos/img_134.png)
...
![img_135.png](Ficheiros_de_suporte/Processos/img_135.png)
...
![img_139.png](Ficheiros_de_suporte/Processos/img_139.png)

**Individual**

Deve o utilizador, escolher a entidade da qual pretende extrair a Autorização de Pagamento.

![img_140.png](Ficheiros_de_suporte/Processos/img_140.png)

:warning:__O utilizador tem de selecionar sempre os documentos que deseja, sejam para consulta ou impressão através da colocação de ![img_checkbox_checked.png](Ficheiros_de_suporte/Processos/img_checkbox_checked.png) no ecrã.__
...
![img_141.png](Ficheiros_de_suporte/Processos/img_141.png)

:warning:__O utilizador tem de selecionar sempre os documentos que deseja, sejam para consulta ou impressão através da colocação de ![img_checkbox_checked.png](Ficheiros_de_suporte/Processos/img_checkbox_checked.png) no ecrã.__
...
|“Pôr autorizações regularizadas”|Opcional|Permite ao utilizador quando o estiver ativo imprimir guias com histórico e em que já tenha ocorrido o recebimento.![img_checkbox_checked_2.png](Ficheiros_de_suporte/Processos/img_checkbox_checked_2.png)|
|Autorização de Pagamento / Autorização Global de Pagamento|Obrigatório|O utilizador escolhe: ![img_autorizacao_pagamento.png](Ficheiros_de_suporte/Processos/img_autorizacao_pagamento.png), sendo que, para mais que um registo existe a possibilidade de "Selecionar Todos" ![img_selecionar_todos.png](Ficheiros_de_suporte/Processos/img_selecionar_todos.png)|
...
![img_144.png](Ficheiros_de_suporte/Processos/img_144.png)

De forma **Global**, ao selecionar “imprimir”, o sistema produz a Autorização de Pagamento Coletiva em PDF.

![img_145.png](Ficheiros_de_suporte/Processos/img_145.png)
...
![img_150.png](Ficheiros_de_suporte/Processos/img_150.png)

|Botão|Descritivo|
|:---|:---|
|Ficheiro|Este botão permite ao utilizador escolher o diretório de gravação do ficheiroTXT. (IGCP) ou XML. (IGCP – Novo) que será gerado. ![img_151.png](Ficheiros_de_suporte/Processos/img_151.png) ![img_152.png](Ficheiros_de_suporte/Processos/img_152.png)|
...
![img_153.png](Ficheiros_de_suporte/Processos/img_153.png)
...
![img_154.png](Ficheiros_de_suporte/Processos/img_154.png)
...
![img_155.png](Ficheiros_de_suporte/Processos/img_155.png)

Nesta etapa, um novo ecrã surge, em que o utilizador tem possibilidade de realizar as seguintes tarefas:

![img_156.png](Ficheiros_de_suporte/Processos/img_156.png)
...
![img_157.png](Ficheiros_de_suporte/Processos/img_157.png) ![img_158.png](Ficheiros_de_suporte/Processos/img_158.png)||
...
![img_160.png](Ficheiros_de_suporte/Processos/img_160.png)
...
![img_161.png](Ficheiros_de_suporte/Processos/img_161.png)
...
![img_162.png](Ficheiros_de_suporte/Processos/img_162.png)
...
![img_163.png](Ficheiros_de_suporte/Processos/img_163.png)
...
![img_164.png](Ficheiros_de_suporte/Processos/img_164.png)
...
![img_165.png](Ficheiros_de_suporte/Processos/img_165.png)

Neste ecrã, o utilizador tem de preencher com a informação de acordo com as instruções do quadro abaixo:

![img_166.png](Ficheiros_de_suporte/Processos/img_166.png)

:warning:__O utilizador tem de selecionar **sempre** os documentos que deseja, sejam para consulta ou impressão através da colocação do visto ![img_checkbox_checked.png](Ficheiros_de_suporte/Processos/img_checkbox_checked.png) no ecrã anterior.__
...
![img_168.png](Ficheiros_de_suporte/Processos/img_168.png)
...
![img_169.png](Ficheiros_de_suporte/Processos/img_169.png)
...
![img_170.png](Ficheiros_de_suporte/Processos/img_170.png)
...
![img_171.png](Ficheiros_de_suporte/Processos/img_171.png)
...
![img_172.png](Ficheiros_de_suporte/Processos/img_172.png)
...
![img_173.png](Ficheiros_de_suporte/Processos/img_173.png)
...
![img_174.png](Ficheiros_de_suporte/Processos/img_174.png)
...
![img_175.png](Ficheiros_de_suporte/Processos/img_175.png)
...
![img_176.png](Ficheiros_de_suporte/Processos/img_176.png)
...
![img_177.png](Ficheiros_de_suporte/Processos/img_177.png)
...
![img_182.png](Ficheiros_de_suporte/Processos/img_182.png)
...
![img_183.png](Ficheiros_de_suporte/Processos/img_183.png)
...
|Primeira data|Obrigatório|Definir intervalo primeira data|
|Última data|Obrigatório|Definir intervalo última data|
|Pôr Guias já regularizadas|Opcional|Permite ao utilizador quando o "![img_checkbox_checked_2.png](Ficheiros_de_suporte/Processos/img_checkbox_checked_2.png)" estiver ativo imprimir guias com histórico e em que já tenha ocorrido o recebimento.|
...
![img_184.png](Ficheiros_de_suporte/Processos/img_184.png)
...
![img_185.png](Ficheiros_de_suporte/Processos/img_185.png)
...
![img_186.png](Ficheiros_de_suporte/Processos/img_186.png)

Os movimentos contabilísticos surgem de forma automática, pelo que o utilizador tem de validar e confirmar.

![img_187.png](Ficheiros_de_suporte/Processos/img_187.png)
...
![img_188.png](Ficheiros_de_suporte/Processos/img_188.png)
...
![img_189.png](Ficheiros_de_suporte/Processos/img_189.png)
...
![img_190.png](Ficheiros_de_suporte/Processos/img_190.png)
...
![img_191.png](Ficheiros_de_suporte/Processos/img_191.png)
...
![img_192.png](Ficheiros_de_suporte/Processos/img_192.png)
...
![img_193.png](Ficheiros_de_suporte/Processos/img_193.png)
...
![img_194.png](Ficheiros_de_suporte/Processos/img_194.png)

<a name="cobrancas_co_2"></a>
### Cobranças (CO)

![img_195.png](Ficheiros_de_suporte/Processos/img_195.png)
...
![img_196.png](Ficheiros_de_suporte/Processos/img_196.png)
...
![img_197.png](Ficheiros_de_suporte/Processos/img_197.png)

Os movimentos contabilísticos surgem de forma automática, pelo que o utilizador tem de validar e confirmar.

![img_198.png](Ficheiros_de_suporte/Processos/img_198.png)
...
![img_199.png](Ficheiros_de_suporte/Processos/img_199.png)

:warning:__O utilizador tem de selecionar **sempre** os documentos que deseja, sejam para consulta ou impressão através da colocação de um visto ![img_checkbox_checked.png](Ficheiros_de_suporte/Processos/img_checkbox_checked.png) no ecrã.__

![img_200.png](Ficheiros_de_suporte/Processos/img_200.png)
...
|Primeira data|Obrigatório|Definir intervalo primeira data|
|Última data|Obrigatório|Definir intervalo última data|
|Outras receitas regularizadas|Opcional|Permite ao utilizador quando o ![img_checkbox_checked_2.png](Ficheiros_de_suporte/Processos/img_checkbox_checked_2.png) estiver ativo imprimir guias com histórico e em que já tenha ocorrido o recebimento.|
...
![img_201.png](Ficheiros_de_suporte/Processos/img_201.png)
...
![img_202.png](Ficheiros_de_suporte/Processos/img_202.png)

O novo ecrã tem o aspeto abaixo mostrado:

![img_203.png](Ficheiros_de_suporte/Processos/img_203.png)
...
![img_204.png](Ficheiros_de_suporte/Processos/img_204.png)
...
![img_205.png](Ficheiros_de_suporte/Processos/img_205.png)
...
![img_206.png](Ficheiros_de_suporte/Processos/img_206.png)
