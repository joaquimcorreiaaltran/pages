...
2.  [Menu Parametrização](#menu_parametrizacao)
  ...
  2.  [Opção Tabelas Genéricas](#op_tabelas_genericas)
    ...
    3. [Fatores de Aglutinação](#op_tabelas_genericas_fatores_aglutinacao)
      ...
      2.  [Listagens](#op_tabelas_genericas_fatores_aglutinacao_listagens)   
    5. [Tipos de Entidades](#op_tabelas_genericas_tipos_entidades)
      1.  [Recolha](#op_tabelas_genericas_tipos_entidades_recolha)
      2.  [Listagens](#op_tabelas_genericas_tipos_entidades_listagens)   
    6. [Instituições Bancárias](#op_tabelas_genericas_instituicoes_bancarias)
      1.  [Recolha](#op_tabelas_genericas_instituicoes_bancarias_recolha)
      2.  [Listagens](#op_tabelas_genericas_instituicoes_bancarias_listagens)   
    7. [Responsáveis](#op_tabelas_genericas_responsaveis)
    8. [R.O.C. - Revisor Oficial de Contas](#op_tabelas_genericas_roc)
  3. [Opção Contabilidade](#op_contabilidade)
    1. [Plano de Contas](#op_contabilidade_plano_contas)
      1. [Recolha](#op_contabilidade_plano_contas_recolha)
      2. [Listagens](#op_contabilidade_plano_contas_listagens)
      3. [(**WIP**)Plano Central](#op_contabilidade_plano_central)
    2. [Contabilidade Pública](#op_contabilidade_publica)
      1. [Classificadores Económicos (Recolha)](#op_contabilidade_publica_classificadores_economicos_recolha)
      2. [Classificadores Económicos (Listagens)](#op_contabilidade_publica_classificadores_economicos_listagens)
      3. [Gestão Fonte de Financiamento](#op_gestao_fonte_financiamento)
      4. [Gestão Programa](#op_gestao_programa)
      5. [Gestão Medida](#op_gestao_medida)
      6. [Gestão Projeto](#op_gestao_projeto)
      7. [Gestão Regionalização](#op_gestao_regionalizacao)
      8. [Gestão Atividade](#op_gestao_atividade)
      9. [Gestão Natureza](#op_gestao_natureza)
      10. [Gestão Departamento](#op_gestao_departamento)
    3. [Tipos de Diário](#op_tipos_diario)
      1. [Recolha](#op_tipos_diario_recolha)
      2. [Listagens](#op_tipos_diario_listagens)
    4. [Centros de Custos](#op_centros_custos)
      1. [Recolha](#op_centros_custos_recolha)
      2. [Listagens](#op_centros_custos_listagens)
    5. [CRI\Departamentos](#op_cri_departamentos)
      1. [Recolha](#op_cri_departamentos_recolha)
      2. [Listagens](#op_cri_departamentos_listagens)
    6. [Associações LCPA](#op_associacoes_lpca)
      1.  [(**WIP**)Recolha - 4A](##op_associacoes_lpca_recolha_4a)
      2.  [(**WIP**)Recolha - 4B](##op_associacoes_lpca_recolha_4b)
      3.  [(**WIP**)Listagens](##op_associacoes_lpca_listagens)
  4. [Terceiros](#op_terceiros)
    1. [Gestão de Entidades](#op_gestao_entidades)
      1. [Recolha](#op_gestao_entidades_recolha)
      2. [Listagens](#op_gestao_entidades_listagens)
    2. [Tabela de Projetos](#op_tabela_projetos)
      1. [Recolha](#op_tabela_projetos_recolha)
      2. [Listagens](#op_tabela_projetos_listagens)
    3. [Gestão de Entidades *Factoring*](#op_gestao_entidades_factoring)
      1. [Recolha](#op_gestao_entidades_factoring_recolha)
      2. [Listagens](#op_gestao_entidades_factoring_listagens)
    4. [(**WIP**)Gestão de Produtos](#op_gestao_produtos)
      1. [(**WIP**)Recolha](#op_gestao_produtos_recolha)
  5.  [(**WIP**)Migração do SIDC](#op_migracao_sidc)
    1. [(**WIP**)Carregamento dos ficheiros CSV](#op_migracao_sidc_carregamento_ficheiros_csv)
    2. [(**WIP**)Validação da informação](#op_migracao_sidc_validacao_informacao)
  6. [Opção Fazer *Logoff*](#op_fazer_logoff)
  7. [Opção Sair](#op_sair)
3.  [Menu Gestão de Terceiros](#menu_gestao_terceiros)
  1.	[Opção Extrato por Entidade](#op_extrato_entidade)
  2.	[Opção Extrato de Processo de Aquisição](#op_extrato_processo_aquisicao)
...
![img_1](Ficheiros_de_suporte/Utilizador/img_1.png)
...
![img_2](Ficheiros_de_suporte/Utilizador/img_2.png)
...
![img_3](Ficheiros_de_suporte/Utilizador/img_3.png)
...
| Código Postal| Código postal associado à instituição. A lista de códigos postais é acessível através do botão redondo que se encontra entre os campos.<br /> ![img_4](Ficheiros_de_suporte/Utilizador/img_4.png)|
...
![img_8](Ficheiros_de_suporte/Utilizador/img_8.png)
...
| F. Finan| Neste campo o utilizador deve indicar o código da Fonte de Financiamento associada. <br />:warning: **Caso qualquer outro campo destes oito for preenchido, este campo passa a ter um preenchimento obrigatório, não podendo assumir o valor zero (0).**<br /> Caso o utilizador pretenda ter acesso à lista de Fontes de Financiamento disponíveis, deve carregar no círculo à direita do campo => ![radio](Ficheiros_de_suporte/Utilizador/img_radio.png).<br />![img_9](Ficheiros_de_suporte/Utilizador/img_9.png)|
| Prog| Neste campo o utilizador deve indicar o código do Programa associado. <br />:warning: **Caso este campo seja preenchido, os campos Fonte de Financiamento e Classificação Funcional passam a ter preenchimento obrigatório, não podendo em qualquer dos casos assumir o valor zero (0).**<br /> Caso o utilizador pretenda ter acesso à lista de Programas disponíveis, deve carregar no círculo à direita do campo =>![radio](Ficheiros_de_suporte/Utilizador/img_radio.png).<br />![img_10](Ficheiros_de_suporte/Utilizador/img_10.png)|
| Medida| Neste campo o utilizador deve indicar o código da Medida associada. <br />:warning: **Caso este campo seja preenchido, os campos Fonte de Financiamento e Classificação Funcional passam a ter preenchimento obrigatório, não podendo em qualquer dos casos assumir o valor zero (0).**<br /> Caso o utilizador pretenda ter acesso à lista de Medidas disponíveis, deve carregar no círculo à direita do campo => ![radio](Ficheiros_de_suporte/Utilizador/img_radio.png).<br />![img_11](Ficheiros_de_suporte/Utilizador/img_11.png)|
| Proj| Neste campo o utilizador deve indicar o código do Projeto associado. <br />:warning: **Caso este campo seja preenchido, os campos Fonte de Financiamento e Classificação Funcional passam a ter preenchimento obrigatório, não podendo em qualquer dos casos assumir o valor zero (0).**<br />Caso o utilizador pretenda ter acesso à lista de Projetos disponíveis, deve carregar no círculo à direita do campo => ![radio](Ficheiros_de_suporte/Utilizador/img_radio.png).<br />![img_12](Ficheiros_de_suporte/Utilizador/img_12.png)|
| Region.| Neste campo o utilizador deve indicar o código da Regionalização associada. <br />:warning: **Caso este campo seja preenchido, os campos Fonte de Financiamento e Classificação Funcional passam a ter preenchimento obrigatório, não podendo em qualquer dos casos assumir o valor zero (0).**<br /> Caso o utilizador pretenda ter acesso à lista de Regionalizações disponíveis, deve carregar no círculo à direita do campo => ![radio](Ficheiros_de_suporte/Utilizador/img_radio.png).<br />![img_13](Ficheiros_de_suporte/Utilizador/img_13.png)|
| Ativ.| Neste campo o utilizador deve indicar o código da Atividade associada. <br />:warning: **Caso este campo seja preenchido, os campos Fonte de Financiamento e Classificação Funcional passam a ter preenchimento obrigatório, não podendo em qualquer dos casos assumir o valor zero (0).**<br /> Caso o utilizador pretenda ter acesso à lista de Atividades disponíveis, deve carregar no círculo à direita do campo => ![radio](Ficheiros_de_suporte/Utilizador/img_radio.png).<br />![img_14](Ficheiros_de_suporte/Utilizador/img_14.png)|
...
| Natur.| Neste campo o utilizador deve indicar o código da Natureza associada. <br />:warning: **Caso este campo seja preenchido, os campos Fonte de Financiamento e Classificação Funcional passam a ter preenchimento obrigatório, não podendo em qualquer dos casos assumir o valor zero (0).**<br /> Caso o utilizador pretenda ter acesso à lista de Naturezas disponíveis, deve carregar no círculo à direita do campo => ![radio](Ficheiros_de_suporte/Utilizador/img_radio.png).<br />![img_15](Ficheiros_de_suporte/Utilizador/img_15.png)|
...
![img_16](Ficheiros_de_suporte/Utilizador/img_16.png)

| Campo| Descrição|
|:---|:---|
| Ambiente| Indicar qual o ambiente da aplicação, tendo as seguintes opção disponíveis: <br />![ambiente_desenvolvimento](Ficheiros_de_suporte/Utilizador/img_ambiente_desenvolvimento.png)|
...
![img_17](Ficheiros_de_suporte/Utilizador/img_17.png)
...
![img_18](Ficheiros_de_suporte/Utilizador/img_18.png)
...
![img_19](Ficheiros_de_suporte/Utilizador/img_19.png)
...
| Botão| Ação|
|:---|:---|
|"…" <br />![...](Ficheiros_de_suporte/Utilizador/img_....png)| Escolher a localização onde pretende guardar a informação a extrair, seja dentro da máquina local ou de uma pasta de rede. O nome do ficheiro é composta pela sigla “LIST_CODPOST_” mais a data de extração, no formato DDMMAAAA ( D – Dia; M – Mês; A – Ano ).|
| Ficheiro| Extrair a informação pretendida para um ficheiro de texto com o formato CSV.|
| Imprimir| Imprimir uma listagem de códigos postal com base nos critérios definidos. O resultado será semelhante ao apresentado:<br />![img_20](Ficheiros_de_suporte/Utilizador/img_20.png)|
| Sair| Sair do ecrã.|
...
![img_21](Ficheiros_de_suporte/Utilizador/img_21.png)
...
| Critério de filtragem| Critério para filtragem da pesquisa. <br /> ![img_codigo_nome_filtrar](Ficheiros_de_suporte/Utilizador/img_codigo_nome_filtrar.png)|
| Critério de posicionamento| Critério a escolher para realçar um resultado da pesquisa. <br /> ![img_posicionar_codigo_nome](Ficheiros_de_suporte/Utilizador/img_posicionar_codigo_nome.png)|
...
![img_22](Ficheiros_de_suporte/Utilizador/img_22.png)
...
| Botão| Ação|
|:---|:---|
|… ![img_...](Ficheiros_de_suporte/Utilizador/img_....png)| escolher a localização onde pretende guardar a informação a extrair, seja dentro da máquina local ou de uma pasta de rede. O nome do ficheiro é composta pela sigla “LIST_BANCOS_” mais a data de extração, no formato DDMMAAAA ( D – Dia; M – Mês; A – Ano ).|
| Ficheiro| Extrair a informação pretendida para um ficheiro de texto com o formato CSV.|
| Imprimir| Imprimir uma listagem de instituições bancárias com base nos critérios definidos. O resultado será semelhante ao apresentado:<br />![img_23](Ficheiros_de_suporte/Utilizador/img_23.png)|
| Sair| Sair do ecrã.|
...
![img_24](Ficheiros_de_suporte/Utilizador/img_24.png)

| Campo| Descrição|
|:---|:---|
| Critério de filtragem| Critério para filtragem da pesquisa. <br />![codigo_nome](Ficheiros_de_suporte/Utilizador/img_codigo_nome.png)|
| Critério de posicionamento| Critério a escolher para realçar um resultado da pesquisa. <br />![codigo_nome](Ficheiros_de_suporte/Utilizador/img_codigo_nome.png)|
...
![img_25](Ficheiros_de_suporte/Utilizador/img_25.png)
...
| Ficheiro| Extrair a informação pretendida para um ficheiro de texto com o formato CSV.|
| Imprimir| Imprimir uma listagem de fatores de aglutinação com base nos critérios definidos. O resultado será semelhante ao apresentado:<br /> ![img_26](Ficheiros_de_suporte/Utilizador/img_26.png)|
| Sair| Sair do ecrã.|
...
![img_27](Ficheiros_de_suporte/Utilizador/img_27.png)
...
![img_29](Ficheiros_de_suporte/Utilizador/img_28.png)
...
|…| Escolher a localização onde pretende guardar a informação a extrair, seja dentro da máquina local ou de uma pasta de rede. O nome do ficheiro é composta pela sigla “LIST_FACAGLU_” mais a data de extração, no formato DDMMAAAA ( D – Dia; M – Mês; A – Ano ).|
| Ficheiro| Extrair a informação pretendida para um ficheiro de texto com o formato CSV.|
| Imprimir| Imprimir uma listagem de tipos de entidades com base nos critérios definidos. O resultado será semelhante ao apresentado:<br />![img_29](Ficheiros_de_suporte/Utilizador/img_29.png)|
| Sair| Sair do ecrã.|
...
![img_30](Ficheiros_de_suporte/Utilizador/img_30.png)
...
![img_31](Ficheiros_de_suporte/Utilizador/img_31.png)
...
| Ficheiro| Extrair a informação pretendida para um ficheiro de texto com o formato CSV.|
| Imprimir| Imprimir uma listagem de instituições bancárias com base nos critérios definidos. O resultado final será semelhante ao apresentado:<br /> ![img_32](Ficheiros_de_suporte/Utilizador/img_32.png)|
| Sair| Sair do ecrã.|
...
![img_33](Ficheiros_de_suporte/Utilizador/img_33.png)
...
![img_34](Ficheiros_de_suporte/Utilizador/img_34.png)
...
| Código Postal| Código Postal de residência do revisor oficial de contas. A parte do código postal (XXXX) deve ser introduzido no primeiro campo e a parte do número postal, no segundo campo. Para obter a listagem de códigos postal, o utilizador deve carregar no círculo ![radio](Ficheiros_de_suporte/Utilizador/img_radio.png) à direita do campo.|
...
| Desbloquear| Desbloquear o registo atual, permitindo assim a sua alteração.|
| Confirmar| Confirmar as alterações efetuadas e registá-las.|
|+ Novo| Introduzir novo revisor oficial de contas. Ao carregar neste botão, todos os campos são limpos e o utilizador deve preencher com os dados pretendidos. No final, o utilizador, tem de carregar no botão Confirmar de forma a que a informação seja validada e gravada.|
|- Abater| Eliminar o revisor oficial de contas que estiver no ecrã. Para registar esta ação, é necessário selecionar o botão "Confirmar".|
| X Cancelar| Cancelar todas as alterações que efetuou desde a abertura o ecrã.|
|<< Primeiro| Posicionar-se no primeiro revisor oficial de contas apresentado com base nos critérios de pesquisa introduzidos ou, caso não tenha sido efetuada nenhuma pesquisa, no primeiro registo existente no sistema.|
|< Anterior| Navegar na listagem de revisor oficial de contas. Neste caso concreto, o utilizar sempre que carregar no botão, andará um registo para trás, ou seja, em direção ao primeiro.|
|> Seguinte| Navegar na listagem de revisor oficial de contas. Neste caso concreto, o utilizar sempre que carregar no botão, andará um registo para a frente, ou seja, em direção ao último.|
...
![img_35](Ficheiros_de_suporte/Utilizador/img_35.png)
...
![img_36](Ficheiros_de_suporte/Utilizador/img_36.png)

| Campo| Descrição|
|:---|:---|
| Exercício| Listagem de exercícios disponíveis conforme o Plano de Contas. Neste campo o utilizador pode escolher o exercício e apenas verá as informações das contas registadas para esse ano. Caso o utilizador pretenda inserir uma nova conta, deve indicar neste campo a qual a exercício que pertence. <br />![img_2015_ano](Ficheiros_de_suporte/Utilizador/img_2015_ano.png)|
| Critério de filtragem| Critério para filtragem da pesquisa. Permite ao utilizador, mediante os critérios de pesquisa disponíveis, efetuar consultas aos dados(contas). Os critérios disponíveis são os indicados na imagem. <br />![tipo](Ficheiros_de_suporte/Utilizador/img_tipo.png)|
| Critério de posicionamento|  Critério a escolher para realçar um resultado da pesquisa. O utilizador pode escolher uma conta e após carregar no botão, o registo atual passa a ser aquele que o utilizador identificou. <br />![posicionar_contas](Ficheiros_de_suporte/Utilizador/img_posicionar_contas.png)|
| Tipo| A informação contida neste campo, indica se a conta selecionada é uma conta do tipo Acumulação ou do tipo Movimento. <br />![acumulacao](Ficheiros_de_suporte/Utilizador/(img_(acumulacao_movimento.png)|
...
| Tipo de Orçamento| Nesta área é apresentado qual ou quais os tipos de orçamento a que a conta pertence. Na inserção de uma nova conta, o utilizador deve marcar os registo que interessam. <br />![tipo_de_orcamento](Ficheiros_de_suporte/Utilizador/img_tipo_de_orcamento.png)|
...
| Rubrica Financeira| Informação relativa à rubrica financeira. No caso da inserção de uma nova conta, o utilizador tem acesso a uma listagem de rubricas financeiras, carregando no círculo ![radio](Ficheiros_de_suporte/Utilizador/img_radio.png) à direita do campo de código. A descrição da rubrica financeira será colocada automaticamente pelo sistema.|
| Rubrica Financeira Ano Anterior| Informação relativa à rubrica financeira do ano anterior. No caso da inserção de uma nova conta, o utilizador tem acesso a uma listagem de rubricas financeiras, carregando no círculo ![radio](Ficheiros_de_suporte/Utilizador/img_radio.png) à direita do campo de código. A descrição da rubrica financeira será colocada automaticamente pelo sistema.|
| Conta Analítica| Informação relativa à conta analítica. No caso da inserção de uma nova conta, o utilizador tem acesso a uma listagem de contas analíticas, carregando no círculo ![radio](Ficheiros_de_suporte/Utilizador/img_radio.png) à direita do campo de código. A descrição da conta analítica será colocada automaticamente pelo sistema.|
| Receita / Despesa| Informação relativa à conta analítica, indicando se é uma conta de despesa ou de receita. Na inserção de uma nova conta, o utilizador deve marcar a opção correta. <br />![receita_despesa](Ficheiros_de_suporte/Utilizador/img_receita_despesa.png)|
| C.E. Rec. / Desp Pub| Valores do resultado do ano anterior, a crédito.|
| Execução Orçamental| Informação relativa ao classificador económico. No caso da inserção de uma nova conta, o utilizador tem acesso a uma listagem de classificadores económicos, carregando no círculo ![radio](Ficheiros_de_suporte/Utilizador/img_radio.png) à direita do campo de código. A descrição do classificador económico será colocada automaticamente pelo sistema.|
...
![img_37](Ficheiros_de_suporte/Utilizador/img_37.png)
...
| Ficheiro| Extrair a informação pretendida para um ficheiro de texto com o formato CSV.|
| Imprimir| Imprimir uma listagem de contas com base nos critérios definidos. O resultado final será semelhante ao apresentado:<br />![img_38](Ficheiros_de_suporte/Utilizador/img_38.png)|
| Sair| Sair do ecrã.|
...
![img_39](Ficheiros_de_suporte/Utilizador/img_39.png)

| Campo| Descrição|
|:---|:---|
| Exercício| Listagem de exercícios disponíveis conforme o Plano de Contas. Neste campo o utilizador pode escolher o exercício e apenas verá as informações das contas registadas para esse ano. Caso o utilizador pretenda inserir uma nova conta, deve indicar neste campo a qual a exercício que pertence. <br />![img_2015_ano](Ficheiros_de_suporte/Utilizador/img_2015_ano.png)|
| Critério de posicionamento|  Critério a escolher para realçar um resultado da pesquisa. O utilizador pode escolher uma conta e após carregar no botão, o registo atual passa a ser aquele que o utilizador identificou.<br />![img_40](Ficheiros_de_suporte/Utilizador/img_40.png)|
| Critério de filtragem| Critério para filtragem da pesquisa. Permite ao utilizador, mediante os critérios de pesquisa disponíveis, efetuar consultas aos dados(contas). Os critérios disponíveis são os indicados na imagem.<br />![img_41](Ficheiros_de_suporte/Utilizador/img_41.png)|
| Código| Esta informação, está dividida em dois campos. O primeiro indica o número da conta, conforme aparece na listagem. E o segundo, apresenta o descritivo dessa mesma conta.<br />![receitas_correntes_e_de_capital](Ficheiros_de_suporte/Utilizador/img_receitas_correntes_e_de_capital.png)|
| Tipo de Movimento| Indicação do tipo de movimento: despesa ou receita.<br />![despesa_despesa](Ficheiros_de_suporte/Utilizador/img_despesa_despesa.png)|
| Tipo de Conta| Indicação do tipo de conta. <br />![tipo_acumulacao](Ficheiros_de_suporte/Utilizador/img_tipo_acumulacao.png)|
| Conta Acumulação| Esta informação, está dividida em dois campos. O primeiro indica o número da conta de acumulação a que pertence a conta selecionada, conforme aparece na listagem. E o segundo, apresenta o descritivo dessa mesma conta.|
...
![img_42](Ficheiros_de_suporte/Utilizador/img_42.png)
...
| Ficheiro| Extrair a informação pretendida para um ficheiro de texto com o formato CSV.|
| Imprimir| Imprimir uma listagem de contas com base nos critérios definidos. O resultado final será semelhante ao apresentado:<br />![img_43](Ficheiros_de_suporte/Utilizador/img_43.png)|
| Sair| Sair do ecrã.|
...
![img_44](Ficheiros_de_suporte/Utilizador/img_44.png)
...
![img_45](Ficheiros_de_suporte/Utilizador/img_45.png)
...
![img_46](Ficheiros_de_suporte/Utilizador/img_46.png)
...
![img_47](Ficheiros_de_suporte/Utilizador/img_47.png)
...
![img_48](Ficheiros_de_suporte/Utilizador/img_48.png)
...
![img_49](Ficheiros_de_suporte/Utilizador/img_49.png)
...
![img_50](Ficheiros_de_suporte/Utilizador/img_50.png)
...
![img_51](Ficheiros_de_suporte/Utilizador/img_51.png)

| Campo| Descrição|
|:---|:---|
| Critério de posicionamento| Critério a escolher para realçar um resultado da pesquisa.. O utilizador pode escolher uma código e após carregar no botão, o registo atual passa a ser aquele que o utilizador identificou. ![posicionar_codigo](Ficheiros_de_suporte/Utilizador/img_posicionar_codigo.png)|
...
![img_52](Ficheiros_de_suporte/Utilizador/img_52.png)
...
| Ficheiro| Extrair a informação pretendida para um ficheiro de texto com o formato CSV.
| Imprimir| Imprimir uma listagem de tipos de diário com base nos critérios definidos. O resultado final será semelhante ao apresentado:<br />![img_53](Ficheiros_de_suporte/Utilizador/img_53.png)|
| Sair| Sair do ecrã.|
...
| Tipo| Este campo indica o tipo de centro de custo.<br />![acumulacao_movimento](Ficheiros_de_suporte/Utilizador/img_acumulacao_movimento.png)|
...
![img_55](Ficheiros_de_suporte/Utilizador/img_55.png)
...
| Ficheiro| Extrair a informação pretendida para um ficheiro de texto com o formato CSV.|
| Imprimir| Imprimir uma listagem de centros de custos com base nos critérios definidos. O resultado final será semelhante ao apresentado:![img_56](Ficheiros_de_suporte/Utilizador/img_56.png)|
| Sair| Sair do ecrã.|
...
![img_57](Ficheiros_de_suporte/Utilizador/img_57.png)

| Campo| Descrição|
|:---|:---|
| Critério de posicionamento| Critério a escolher para realçar um resultado da pesquisa. O utilizador pode escolher um centro de responsabilidade integrado e após carregar no botão, o registo atual passa a ser aquele que o utilizador identificou.<br />![posicionar_codigo_2](Ficheiros_de_suporte/Utilizador/img_posicionar_codigo_2.png)|
...
![img_58](Ficheiros_de_suporte/Utilizador/img_58.png)
...
![img_59](Ficheiros_de_suporte/Utilizador/img_59.png)
...
![img_60](Ficheiros_de_suporte/Utilizador/img_60.png)
...
| Intragrupo| Este campos indica se a entidade é intragrupo ou não. Caso seja, é apresentado um campo com o descritivo do intragrupo.<br />![intragrupo](Ficheiros_de_suporte/Utilizador/img_intragrupo.png)|
| Entidade Parceira| Este campos indica se a entidade é uma entidade parceira ou não. Caso seja, é apresentado um campo com o descritivo da entidade parceira.<br />![entidade_parceira](Ficheiros_de_suporte/Utilizador/img_entidade_parceira.png)|
| Tipo de Entidade| Identificação do tipo de entidade. Na inserção ou alteração de um registo, o utilizador carregando no círculo ![radio](Ficheiros_de_suporte/Utilizador/img_radio.png) entre o campo de código e descritivo pode obter uma listagem de todos os tipos de entidades disponíveis.|
| Fator de Aglutinação| Identificação do fator de aglutinação. Na inserção ou alteração de um registo, o utilizador carregando no círculo ![radio](Ficheiros_de_suporte/Utilizador/img_radio.png) entre o campo de código e descritivo pode obter uma listagem de todos os fator de aglutinação disponíveis.|
| Nome| Nome ou descrição da entidade.|
| Morada| Morada da entidade.|
| Localidade| Localidade da entidade.|
| País| País da entidade. Na inserção ou alteração de um registo, o utilizador carregando no círculo ![radio](Ficheiros_de_suporte/Utilizador/img_radio.png) entre o campo de código e descritivo pode obter uma listagem de todos os países disponíveis.|
...
|(Entidade) – Tipo| Tipo de número de conta bancária: <br /> - NIB : Numero de Identificação Bancária; <br /> - IBAN : Número Internacional de Conta Bancária.<br />![tipo_nib](Ficheiros_de_suporte/Utilizador/img_tipo_nib.png)|
...
![img_61](Ficheiros_de_suporte/Utilizador/img_61.png)

| Campo| Descrição|
|:---|:---|
| Critério de filtragem| Critério para filtragem da pesquisa. Permite ao utilizador, mediante os critérios de pesquisa disponíveis, efetuar consultas aos dados.<br />![codigo_de_entidade](Ficheiros_de_suporte/Utilizador/img_codigo_de_entidade.png)|
| Critério de posicionamento| Critério a escolher para realçar um resultado da pesquisa. O utilizador pode escolher um NIF e após carregar no botão, o registo atual passa a ser aquele que o utilizador identificou.<br />![posicionar_num_contribuinte](Ficheiros_de_suporte/Utilizador/img_posicionar_num_contribuinte.png)|
| Nº de Contribuinte| Número de identificação fiscal da entidade.|
...
![img_63](Ficheiros_de_suporte/Utilizador/img_63.png)
...
![img_64](Ficheiros_de_suporte/Utilizador/img_64.png)

| Campo| Descrição|
|:---|:---|
| Critério de posicionamento| Critério a escolher para realçar um resultado da pesquisa. O utilizador pode escolher um código de projeto e após carregar no botão, o registo atual passa a ser aquele que o utilizador identificou.<br />![posicionar_num_contribuinte](Ficheiros_de_suporte/Utilizador/img_posicionar_num_contribuinte.png)|
...
![img_65](Ficheiros_de_suporte/Utilizador/img_65.png)
...
| Botão| Ação|
|:---|:---|
|…| Escolher a localização onde pretende guardar a informação a extrair, seja dentro da máquina local ou de uma pasta de rede. O nome do ficheiro é composta pela sigla “LIST_PROJECTOS_” mais a data de extração, no formato DDMMAAAA ( D – Dia; M – Mês; A – Ano ).|
| Ficheiro| Extrair a informação pretendida para um ficheiro de texto com o formato CSV.|
...
![img_66](Ficheiros_de_suporte/Utilizador/img_66.png)
...
| Email| Endereço de correio eletrónico da entidade.|
| Nº de Contribuinte| Número de identificação fiscal da entidade.|
|(Entidade *Factoring*) – Tipo| Tipo de número de conta bancária:<br />- NIB : Numero de Identificação Bancária;<br />- IBAN : Número Internacional de Conta Bancária.<br />![tipo_nib](Ficheiros_de_suporte/Utilizador/img_tipo_nib.png)|
...
![img_67](Ficheiros_de_suporte/Utilizador/img_67.png)
...
![img_68](Ficheiros_de_suporte/Utilizador/img_68.png)
...
![img_69](Ficheiros_de_suporte/Utilizador/img_69.png)

<a name="op_sair"></a>
## Sair

![img_70](Ficheiros_de_suporte/Utilizador/img_70.png)
...
![img_71](Ficheiros_de_suporte/Utilizador/img_71.png)
...
![img_72](Ficheiros_de_suporte/Utilizador/img_72.png)

| Campo| Descrição|
|:---|:---|
| Tipo| Este campo permite ao utilizador efetuar a pesquisa de entidades, através do código da mesma ou do respectivo número de contribuinte.<br />![posicionar_num_contribuinte](Ficheiros_de_suporte/Utilizador/img_posicionar_num_contribuinte.png)|
...
| Exercício| O utilizador tem de obrigatoriamente escolher para qual o exercício que pretende obter a informação, sendo por defeito escolhido o período corrente.<br />![exercicio_2015](Ficheiros_de_suporte/Utilizador/img_exercicio_2015.png)|
...
| Ficheiro| Extrair a informação pretendida para um ficheiro de texto com o formato CSV.
| Imprimir| Imprimir uma listagem de entidades com base nos critérios definidos. O resultado final do documento será semelhante ao apresentado:<br />![img_73](Ficheiros_de_suporte/Utilizador/img_73.png)|
| Email|  enviar informação acerca das entidades por email. Ao carregar no mesmo é apresentado o seguinte ecrã:<br />![img_74](Ficheiros_de_suporte/Utilizador/img_74.png) <br /><br />Neste ecrã o utilizador deve escolher os critérios de selecção para gerar os dados a enviar por email, nomeadamente:<br /> <br />- Exercício;<br /> <br />- Data de Referência;<br /> <br />- Número da primeira entidade;<br /> <br />- Número da última entidade;<br /> <br />- Tipo de informação pretendida: Conta Corrente, Notas de Encomenda, Autorizações de pagamento ou Faturas em Conferencia/Recepção.<br /><br /> Para calcular a informação a enviar, por email, o utilizador deve carregar no botão Calcular. O resultado dos cálculos aparecerá no ecrã. ![calcular](Ficheiros_de_suporte/Utilizador/img_calcular.png)<br />Antes de proceder ao envio do email, o utilizador deve indicar a pasta onde será gravado temporariamente o ficheiro a enviar em anexo à mensagem. ![img_mail_29092015.csv](Ficheiros_de_suporte/Utilizador/img_mail_29092015.csv.png). <br />Para confirmar o envio do documento, o utilizador deve carregar no botão Ficheiro de Mails. ![ficheiro_de_mails](Ficheiros_de_suporte/Utilizador/img_ficheiro_de_mails.png). <br />Para sair do ecrã o utilizador deve carregar no botão Sair.<br /> ![sair](Ficheiros_de_suporte/Utilizador/img_sair.png)|
| Sair| Sair do ecrã.|

#### Tabulação – Conta Corrente

![img_75](Ficheiros_de_suporte/Utilizador/img_75.png)
...
|:---|:---|
|*Totais de Credores*||
| Faturas (P2) \ Débitos| Valor total de faturas (documentos do tipo P2) e débitos.|
| Notas de Crédito \ Créditos| Valor total das notas de crédito e de créditos.|
| Anulações (AC)| Valor total das anulações (documentos do tipo AC).|
| Pagamentos (PG)| Valor total de Pagamentos (documentos do tipo PG).|
| Totais| Somatório dos campos anteriores.|
|*Totais Devedores*||
| Faturas (FD)| Valor total de faturas (documentos do tipo FD).|
| Anulações (AD)| Valor total de anulações (documentos do tipo AD).|
...
![img_76](Ficheiros_de_suporte/Utilizador/img_76.png)
...
![img_77](Ficheiros_de_suporte/Utilizador/img_77.png)
...
![img_78](Ficheiros_de_suporte/Utilizador/img_78.png)
...
| Campo| Descrição|
|:---|:---|
| Estado da Fatura| Critérios de visualização dos totalizadores apresentados nos campos: <br />- Autorização de Pagamentos; <br />- Total de Faturas; Sendo os critérios os seguintes: <br />- Pagas: Apresenta apenas os totais das faturas já pagas; <br />- Não Pagas: Apresenta apenas os totais das faturas ainda por pagar; <br />- Todas: Apresenta os totais das faturas.|
...
![img_79](Ficheiros_de_suporte/Utilizador/img_79.png)
...
| Botão| Ação|
|:---|:---|
| Calcular| Calcular os dados a serem apresentados com base nas condições de pesquisa selecionados (de notar que não é obrigatório preencher todos estes campos para obter resultados): <br />- Ano; <br />- Primeiro Número; <br />- Último Número; <br />- Primeira Data; <br />- Última Data; <br />- Primeira Entidade; <br />- Última Entidade.|
| Ficheiro| Extrair a informação pretendida para um ficheiro de texto com o formato CSV.|
| Sair| Sair do ecrã corrente.|

#### Tabulação – Processo de Aquisição/Compromisso Assumido

![img_80](Ficheiros_de_suporte/Utilizador/img_80.png)
...
| Botão| Ação|
|:---|:---|
| Ficheiro| Extrair a informação pretendida para um ficheiro de texto com o formato CSV. O utilizador deve indicar a localização onde o ficheiro será guardado através do seguinte botão:<br />![...](Ficheiros_de_suporte/Utilizador/img_....png)|


#### Tabulação – Compromisso Assumido/Proc. Aquisição

![img_81](Ficheiros_de_suporte/Utilizador/img_81.png)
...
![img_82](Ficheiros_de_suporte/Utilizador/img_82.png)
...
![img_83](Ficheiros_de_suporte/Utilizador/img_83.png)
...
| Tipo de Data| Indica que tipo de data deve ser utilizada|
...
|(Tab.) Faturas Credoras| Indica o estado atual das faturas credoras. O utilizador deve indicar o tipo de faturas que pretende pesquisar: Por Pagar Faturas ainda não pagas. Anuladas Faturas anuladas. Pagas Faturas pagas. Todas Todas as faturas anteriores|
|(Tab.) Faturas Devedoras| Indica o estado atual das faturas devedoras. O utilizador deve indicar o tipo de faturas que pretende pesquisar: Por Cobrar Faturas ainda por cobrar. Anuladas Faturas anuladas. Cobradas Faturas já cobradas. Todas Todas as faturas anteriores|
|(Tab.) Crédito a Clientes| Indica o estado atual das faturas de crédito a clientes. O utilizador deve indicar o tipo de faturas que pretende pesquisar: Por Cobrar Créditos ainda por cobrar. Anuladas Créditos anulados. Cobradas Créditos já cobrados. Todas Todos os créditos anteriores.|
|(Tab.) Notas de Crédito| Indica o estado atual das notas de crédito a clientes. O utilizador deve indicar o tipo de faturas que pretende pesquisar: Por Cobrar Notas de crédito ainda por cobrar. Anuladas Notas de crédito anuladas. Cobradas Notas de crédito já cobrados. Todas Todos as notas de crédito anteriores.|
|(Tab.) Tipos de Documento| Indica o estado atual das notas de crédito a clientes. O utilizador deve indicar o tipo de faturas que pretende pesquisar: Por Regularizar Faturas por regularizar. Regularizar Faturas já regularizadas. Todas Todos as notas de crédito anteriores. E por tipo de documento, a escolher na listagem apresentada à direita.|
...
| Botão| Ação|
|:---|:---|
| Calcular| Obter o mapa de gestão com base nos critérios indicados pelo utilizador. <br />![img_84](Ficheiros_de_suporte/Utilizador/img_84.png)|
| Imprimir| Extrair a informação pretendida para um ficheiro de relatório com o formato PDF.<br />![img_85](Ficheiros_de_suporte/Utilizador/img_85.png)|
...
![img_86](Ficheiros_de_suporte/Utilizador/img_86.png)
...
| Estado| Permite escolher o estado dos registos a pesquisar. | Exercício | Permite escolher o exercício a que pertencem os documentos.|

| Botão| Ação|
|:---|:---|
| Calcular| Obter o mapa de gestão com base nos critérios indicados pelo utilizador.<br />![img_88](Ficheiros_de_suporte/Utilizador/img_88.png)|
| Ficheiro CSV| Extrair a informação pretendida para um ficheiro de texto com o formato CSV. O utilizador deve indicar a localização onde o ficheiro será guardado através do seguinte botão: sendo o ficheiro guardado na localização indicada em: O nome do ficheiro será GTFTDATA.|
| Imprimir| Extrair a informação pretendida para um ficheiro de relatório com o formato PDF.<br />![img_89](Ficheiros_de_suporte/Utilizador/img_89.png)|
| Sair| Sair do ecrã atual e voltar ao menu principal.|
